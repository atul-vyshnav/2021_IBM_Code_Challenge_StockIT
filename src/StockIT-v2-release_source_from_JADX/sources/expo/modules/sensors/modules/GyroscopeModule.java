...
public class GyroscopeModule extends BaseSensorModule {
    ...
    public SensorService getSensorService() {
        return (SensorService) getModuleRegistry().getModule(GyroscopeService.class);
    }
    ...
    public void isAvailableAsync(Promise promise) {
        promise.resolve(Boolean.valueOf(((SensorManager) getContext().getSystemService("sensor")).getDefaultSensor(4) != null));
    }
}
