...
public class MagnetometerModule extends BaseSensorModule {
    ...
    public SensorService getSensorService() {
        return (SensorService) getModuleRegistry().getModule(MagnetometerService.class);
    }
    ...
    public void isAvailableAsync(Promise promise) {
        promise.resolve(Boolean.valueOf(((SensorManager) getContext().getSystemService("sensor")).getDefaultSensor(2) != null));
    }
}
