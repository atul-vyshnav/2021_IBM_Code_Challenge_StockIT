...
final /* synthetic */ class PermissionsModule$askAsync$1 extends FunctionReferenceImpl implements Function2<PermissionsResponseListener, String[], Unit> {
    PermissionsModule$askAsync$1(Permissions permissions) {
        super(2, permissions, Permissions.class, "askForPermissions", "askForPermissions(Lorg/unimodules/interfaces/permissions/PermissionsResponseListener;[Ljava/lang/String;)V", 2);
    }
