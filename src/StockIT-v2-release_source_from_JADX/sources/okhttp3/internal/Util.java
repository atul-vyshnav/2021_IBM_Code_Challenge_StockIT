...
public final class Util {
    ...
    public static final Headers EMPTY_HEADERS = Headers.m1177of(new String[0]);
    ...
    private static final Options UNICODE_BOMS = Options.m1181of(ByteString.decodeHex("efbbbf"), ByteString.decodeHex("feff"), ByteString.decodeHex("fffe"), ByteString.decodeHex("0000ffff"), ByteString.decodeHex("ffff0000"));
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String str;
        if (httpUrl.host().contains(ParameterizedMessage.ERROR_MSG_SEPARATOR)) {
            str = "[" + httpUrl.host() + "]";
        } else {
            str = httpUrl.host();
        }
        ...
        return str + ParameterizedMessage.ERROR_MSG_SEPARATOR + httpUrl.port();
    }
        ...
        while (true) {
            if (i >= i2) {
                ...
                if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                    if (i3 != 0) {
                        if (str.regionMatches(i, ParameterizedMessage.ERROR_MSG_SEPARATOR, 0, 1)) {
                            i++;
