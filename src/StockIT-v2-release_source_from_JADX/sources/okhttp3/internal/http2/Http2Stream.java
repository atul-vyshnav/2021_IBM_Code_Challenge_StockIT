...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f1308id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void writeHeaders(List<Header> list, boolean z, boolean z2) throws IOException {
        if (list != null) {
            ...
            this.connection.writeHeaders(this.f1308id, z, list);
            if (z2) {
    ...
    public void close(ErrorCode errorCode2, @Nullable IOException iOException) throws IOException {
        if (closeInternal(errorCode2, iOException)) {
            this.connection.writeSynReset(this.f1308id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2, (IOException) null)) {
            this.connection.writeSynResetLater(this.f1308id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2, @Nullable IOException iOException) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f1308id);
            return true;
        }
    }
                        ...
                        try {
                            ...
                            if (this.closed) {
                                ...
                                if (th == null && Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                                    Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f1308id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    final class FramingSink implements Sink {
            ...
            if (z) {
                try {
                    if (min == this.sendBuffer.size()) {
                        z2 = true;
                        Http2Stream.this.connection.writeData(Http2Stream.this.f1308id, z2, this.sendBuffer, min);
                        Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
                    }
                } catch (Throwable th2) {
                    Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x003a, code lost:
            r8.this$0.connection.writeHeaders(r8.this$0.f1308id, true, okhttp3.internal.Util.toHeaderBlock(r8.trailers));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x005c, code lost:
            r8.this$0.connection.writeData(r8.this$0.f1308id, true, (okio.Buffer) null, 0);
         */
