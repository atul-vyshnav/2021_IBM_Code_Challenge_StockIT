...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public okhttp3.C3401Response intercept(okhttp3.Interceptor.Chain r9) throws java.io.IOException {
        /*
            r8 = this;
    ...
    private Request followUpRequest(C3401Response response, @Nullable Route route) throws IOException {
        String header;
        HttpUrl resolve;
        Proxy proxy;
        if (response != null) {
    ...
    private int retryAfter(C3401Response response, int i) {
