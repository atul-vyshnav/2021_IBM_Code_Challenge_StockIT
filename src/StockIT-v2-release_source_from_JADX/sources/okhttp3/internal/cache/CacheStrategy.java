...
public final class CacheStrategy {
    @Nullable
    public final C3401Response cacheResponse;
    @Nullable
    public final Request networkRequest;

    CacheStrategy(Request request, C3401Response response) {
    ...
    public static boolean isCacheable(okhttp3.C3401Response r3, okhttp3.Request r4) {
        /*
            int r0 = r3.code()
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, C3401Response response) {
            this.nowMillis = j;
        ...
        public CacheStrategy get() {
            ...
            return (candidate.networkRequest == null || !this.request.cacheControl().onlyIfCached()) ? candidate : new CacheStrategy((Request) null, (C3401Response) null);
        }

        private CacheStrategy getCandidate() {
            if (this.cacheResponse == null) {
                return new CacheStrategy(this.request, (C3401Response) null);
            }
            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j2 < j + computeFreshnessLifetime) {
                    C3401Response.Builder newBuilder = this.cacheResponse.newBuilder();
                    if (j2 >= computeFreshnessLifetime) {
                        newBuilder.addHeader(Constants.BluetoothLogLevel.WARNING, "110 HttpURLConnection \"Response is stale\"");
                    }
                    if (cacheResponseAge > DateUtils.MILLIS_PER_DAY && isFreshnessLifetimeHeuristic()) {
                        newBuilder.addHeader(Constants.BluetoothLogLevel.WARNING, "113 HttpURLConnection \"Heuristic expiration\"");
                    }
