...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m1179of(bArr).base64();
    ...
    public /* synthetic */ void lambda$new$0$RealWebSocket() {
        do {
            try {
                ...
                failWebSocket(e, (C3401Response) null);
                return;
            }
        } while (writeOneFrame());
    }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        newWebSocketCall.enqueue(new Callback() {
            public void onResponse(Call call, C3401Response response) {
                ...
                try {
                    ...
                    try {
                        ...
                        RealWebSocket.this.failWebSocket(e, (C3401Response) null);
                    }
            ...
            public void onFailure(Call call, IOException iOException) {
                RealWebSocket.this.failWebSocket(iOException, (C3401Response) null);
            }
        });
    }

    /* access modifiers changed from: package-private */
    public void checkUpgradeSuccess(C3401Response response, @Nullable Exchange exchange) throws IOException {
    ...
    public synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p027ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    private synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p027ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005e, code lost:
        if ((r4 instanceof okhttp3.internal.p027ws.RealWebSocket.Message) == false) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        r2 = ((okhttp3.internal.p027ws.RealWebSocket.Message) r4).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p027ws.RealWebSocket.Message) r4).formatOpcode, (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x008e, code lost:
        if ((r4 instanceof okhttp3.internal.p027ws.RealWebSocket.Close) == false) goto L_0x00a5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0090, code lost:
        r4 = (okhttp3.internal.p027ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p027ws.RealWebSocket.Close     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0034:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p027ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0055:
            ...
            goto L_0x00a0
        L_0x005c:
            boolean r2 = r4 instanceof okhttp3.internal.p027ws.RealWebSocket.Message     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x008c
            r2 = r4
            okhttp3.internal.ws.RealWebSocket$Message r2 = (okhttp3.internal.p027ws.RealWebSocket.Message) r2     // Catch:{ all -> 0x00ab }
            okio.ByteString r2 = r2.data     // Catch:{ all -> 0x00ab }
            okhttp3.internal.ws.RealWebSocket$Message r4 = (okhttp3.internal.p027ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00ab }
        ...
        L_0x008c:
            boolean r2 = r4 instanceof okhttp3.internal.p027ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x00a5
            okhttp3.internal.ws.RealWebSocket$Close r4 = (okhttp3.internal.p027ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x00ab }
        ...
        L_0x00b0:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p027ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
        failWebSocket(new java.net.SocketTimeoutException("sent ping but didn't receive pong within " + r7.pingIntervalMillis + "ms (after " + (r1 - 1) + " successful ping/pongs)"), (okhttp3.C3401Response) null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x004f, code lost:
        failWebSocket(r0, (okhttp3.C3401Response) null);
     */
    ...
    public void writePingFrame() {
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p027ws.RealWebSocket.writePingFrame():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable okhttp3.C3401Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p027ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
