...
public final class Exchange {
    ...
    public C3401Response.Builder readResponseHeaders(boolean z) throws IOException {
        try {
            C3401Response.Builder readResponseHeaders = this.codec.readResponseHeaders(z);
    ...
    public void responseHeadersEnd(C3401Response response) {
        this.eventListener.responseHeadersEnd(this.call, response);
    }

    public ResponseBody openResponseBody(C3401Response response) throws IOException {
        try {
