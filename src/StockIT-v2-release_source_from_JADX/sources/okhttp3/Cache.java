...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.internalCache = new InternalCache() {
            @Nullable
            public C3401Response get(Request request) throws IOException {
                return Cache.this.get(request);
            }

            @Nullable
            public CacheRequest put(C3401Response response) throws IOException {
            ...
            public void update(C3401Response response, C3401Response response2) {
    ...
    @Nullable
    public C3401Response get(Request request) {
        try {
            ...
            try {
                ...
                C3401Response response = entry.response(snapshot);
    ...
    /* access modifiers changed from: package-private */
    @Nullable
    public CacheRequest put(C3401Response response) {
        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                L_0x003d:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: okhttp3.Cache.C33922.hasNext():boolean");
            }
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m1179of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
