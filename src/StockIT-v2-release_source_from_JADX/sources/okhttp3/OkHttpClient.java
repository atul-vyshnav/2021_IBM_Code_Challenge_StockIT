...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    static {
        Internal.instance = new Internal() {
            ...
            public int code(C3401Response.Builder builder) {
                return builder.code;
            }
            ...
            public void initExchange(C3401Response.Builder builder, Exchange exchange) {
                builder.initExchange(exchange);
            }

            @Nullable
            public Exchange exchange(C3401Response response) {
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(long j, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, j, timeUnit);
            return this;
        }
