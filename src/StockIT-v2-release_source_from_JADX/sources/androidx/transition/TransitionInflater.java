            ...
            while (true) {
                ...
                if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                    if (next == 2) {
                        ...
                        } else if (GeofencingGooglePlayServicesProvider.TRANSITION_EXTRA_ID.equals(name)) {
                            transition2 = (Transition) createCustom(attributeSet, Transition.class, GeofencingGooglePlayServicesProvider.TRANSITION_EXTRA_ID);
