...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0064R.C0067id.decor_content_parent);
            ...
            if (viewGroup != null) {
                ...
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0064R.C0067id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0064R.C0067id.action_bar_activity_content);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0064R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0064R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0064R.attr.actionBarSize
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0064R.C0067id.action_mode_bar_stub
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0064R.styleable.AppCompatTheme).getString(C0064R.styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0064R.C0065color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0064R.C0065color.abc_decor_view_status_guard);
        }
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0064R.layout.abc_list_menu_item_layout);
