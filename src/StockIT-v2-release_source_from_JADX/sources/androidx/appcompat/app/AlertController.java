...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0064R.styleable.AlertDialog, C0064R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0064R.C0067id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0064R.C0067id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0064R.C0067id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0064R.C0067id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0064R.C0067id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0064R.C0067id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0064R.C0067id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0064R.C0067id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0064R.C0067id.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0064R.C0067id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0064R.C0067id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0064R.C0067id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0064R.C0067id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0064R.C0067id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0064R.C0067id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0064R.C0067id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0064R.C0067id.scrollView);
