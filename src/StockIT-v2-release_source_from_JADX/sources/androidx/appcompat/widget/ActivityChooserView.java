...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(getContext()).inflate(C0064R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        View findViewById = findViewById(C0064R.C0067id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0064R.C0067id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0064R.C0067id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0064R.C0067id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0064R.C0067id.image);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0064R.C0067id.list_item) {
                ...
                ((ImageView) view.findViewById(C0064R.C0067id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0064R.C0067id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                inflate.setId(1);
                ((TextView) inflate.findViewById(C0064R.C0067id.title)).setText(ActivityChooserView.this.getContext().getString(C0064R.string.abc_activity_chooser_view_see_all));
                return inflate;
            }
        }
