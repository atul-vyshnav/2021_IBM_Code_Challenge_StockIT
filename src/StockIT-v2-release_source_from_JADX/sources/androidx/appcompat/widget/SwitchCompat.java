...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTextOn = obtainStyledAttributes.getText(C0064R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0064R.styleable.SwitchCompat_android_textOff);
        ...
        PorterDuff.Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0064R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        PorterDuff.Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0064R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
