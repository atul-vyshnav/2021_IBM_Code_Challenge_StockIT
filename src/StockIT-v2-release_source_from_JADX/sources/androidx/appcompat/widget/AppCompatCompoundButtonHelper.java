...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0064R.styleable.CompoundButton
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0064R.styleable.CompoundButton
            ...
            int r11 = androidx.appcompat.C0064R.styleable.CompoundButton_buttonCompat     // Catch:{ all -> 0x0092 }
        ...
        L_0x0041:
            ...
            int r11 = androidx.appcompat.C0064R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x0092 }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x0092 }
            if (r11 == 0) goto L_0x0062
            int r11 = androidx.appcompat.C0064R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x0092 }
            int r11 = r0.getResourceId(r11, r2)     // Catch:{ all -> 0x0092 }
        ...
        L_0x0062:
            int r11 = androidx.appcompat.C0064R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x0092 }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x0092 }
            if (r11 == 0) goto L_0x0075
            android.widget.CompoundButton r11 = r10.mView     // Catch:{ all -> 0x0092 }
            int r12 = androidx.appcompat.C0064R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x0092 }
        ...
        L_0x0075:
            int r11 = androidx.appcompat.C0064R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x0092 }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x0092 }
            if (r11 == 0) goto L_0x008e
            android.widget.CompoundButton r11 = r10.mView     // Catch:{ all -> 0x0092 }
            int r12 = androidx.appcompat.C0064R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x0092 }
            r1 = -1
