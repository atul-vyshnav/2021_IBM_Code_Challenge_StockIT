...
public final class CapturedTypeApproximationKt {
    ...
    private static final TypeProjection toTypeProjection(TypeArgument typeArgument) {
        ...
        if (_Assertions.ENABLED && !isConsistent) {
            DescriptorRenderer withOptions = DescriptorRenderer.Companion.withOptions(C3375x8e300b6.INSTANCE);
    ...
    public static final TypeProjection approximateCapturedTypesIfNecessary(TypeProjection typeProjection, boolean z) {
        ...
        if (!TypeUtils.contains(type, C3373x21acc51c.INSTANCE)) {
            return typeProjection;
        }
    ...
    private static final TypeProjection substituteCapturedTypesWithProjections(TypeProjection typeProjection) {
        TypeSubstitutor create = TypeSubstitutor.create((TypeSubstitution) new C3374x12aaa596());
