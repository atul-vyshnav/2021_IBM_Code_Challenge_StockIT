...
final class MemberDeserializer$getAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<AnnotationDescriptor> invoke() {
        ...
        if (access$asProtoContainer == null) {
            ...
            list = CollectionsKt.toList(this.this$0.f1294c.getComponents().getAnnotationAndConstantLoader().loadCallableAnnotations(access$asProtoContainer, this.$proto, this.$kind));
        }
