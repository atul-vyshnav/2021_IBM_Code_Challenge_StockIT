...
final class C3218xb250426d extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFConsumer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C3218xb250426d(String str) {
        super(1);
        this.$JFConsumer = str;
    }
