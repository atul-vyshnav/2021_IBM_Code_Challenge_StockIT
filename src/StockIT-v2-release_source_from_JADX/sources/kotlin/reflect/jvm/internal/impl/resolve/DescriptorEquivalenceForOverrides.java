...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        Intrinsics.checkNotNullParameter(callableDescriptor, NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY);
        ...
        if (!DescriptorUtils.isLocal(declarationDescriptor)) {
            ...
            if (DescriptorUtils.isLocal(declarationDescriptor2) || !ownersEquivalent(declarationDescriptor, declarationDescriptor2, C3323xc15c0bd8.INSTANCE, z)) {
                return false;
            }
            OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new C3324x10bda471(this, z, callableDescriptor, callableDescriptor2));
