...
public final class JavaTypeResolver {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f1283c;
    ...
    public JavaTypeResolver(LazyJavaResolverContext lazyJavaResolverContext, TypeParameterResolver typeParameterResolver2) {
        ...
        this.f1283c = lazyJavaResolverContext;
    ...
    public final KotlinType transformJavaType(JavaType javaType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (javaType instanceof JavaPrimitiveType) {
            ...
            if (type != null) {
                simpleType = this.f1283c.getModule().getBuiltIns().getPrimitiveKotlinType(type);
            } else {
                simpleType = this.f1283c.getModule().getBuiltIns().getUnitType();
            }
            ...
            if (javaType instanceof JavaArrayType) {
                ...
                SimpleType defaultBound = this.f1283c.getModule().getBuiltIns().getDefaultBound();
                Intrinsics.checkNotNullExpressionValue(defaultBound, "c.module.builtIns.defaultBound");
                return defaultBound;
            } else if (javaType == null) {
                SimpleType defaultBound2 = this.f1283c.getModule().getBuiltIns().getDefaultBound();
    ...
    public final KotlinType transformArrayType(JavaArrayType javaArrayType, JavaTypeAttributes javaTypeAttributes, boolean z) {
        ...
        LazyJavaAnnotations lazyJavaAnnotations = new LazyJavaAnnotations(this.f1283c, javaArrayType, true);
        if (type != null) {
            SimpleType primitiveArrayKotlinType = this.f1283c.getModule().getBuiltIns().getPrimitiveArrayKotlinType(type);
        ...
        if (javaTypeAttributes.isForAnnotationParameter()) {
            SimpleType arrayType = this.f1283c.getModule().getBuiltIns().getArrayType(z ? Variance.OUT_VARIANCE : Variance.INVARIANT, transformJavaType, lazyJavaAnnotations);
        ...
        SimpleType arrayType2 = this.f1283c.getModule().getBuiltIns().getArrayType(Variance.INVARIANT, transformJavaType, annotations);
        Intrinsics.checkNotNullExpressionValue(arrayType2, "c.module.builtIns.getArrayType(INVARIANT, componentType, annotations)");
        return KotlinTypeFactory.flexibleType(arrayType2, this.f1283c.getModule().getBuiltIns().getArrayType(Variance.OUT_VARIANCE, transformJavaType, annotations).makeNullableAsSpecified(true));
    }
    ...
    private final SimpleType computeSimpleJavaClassifierType(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, SimpleType simpleType) {
        ...
        if (annotations == null) {
            annotations = new LazyJavaAnnotations(this.f1283c, javaClassifierType, false, 4, (DefaultConstructorMarker) null);
        }
        ...
        if (classifier instanceof JavaClass) {
            ...
            if (fqName != null) {
                ...
                if (mapKotlinClass == null) {
                    mapKotlinClass = this.f1283c.getComponents().getModuleClassResolver().resolveClass(javaClass);
                }
                if (mapKotlinClass != null) {
    ...
    private final TypeConstructor createNotFoundClass(JavaClassifierType javaClassifierType) {
        ...
        TypeConstructor typeConstructor = this.f1283c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses().getClass(classId, CollectionsKt.listOf(0)).getTypeConstructor();
    ...
    private final ClassDescriptor mapKotlinClass(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, FqName fqName) {
        if (javaTypeAttributes.isForAnnotationParameter() && Intrinsics.areEqual((Object) fqName, (Object) JavaTypeResolverKt.JAVA_LANG_CLASS_FQ_NAME)) {
            return this.f1283c.getComponents().getReflectionTypes().getKClass();
        }
        JavaToKotlinClassMapper javaToKotlinClassMapper = JavaToKotlinClassMapper.INSTANCE;
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(javaToKotlinClassMapper, fqName, this.f1283c.getModule().getBuiltIns(), (Integer) null, 4, (Object) null);
    ...
    private final java.util.List<kotlin.reflect.jvm.internal.impl.types.TypeProjection> computeArguments(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType r9, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes r10, kotlin.reflect.jvm.internal.impl.types.TypeConstructor r11) {
        ...
        L_0x0046:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r5 = r8.f1283c
