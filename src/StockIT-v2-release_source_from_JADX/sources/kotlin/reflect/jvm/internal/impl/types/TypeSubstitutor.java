...
public class TypeSubstitutor {
        ...
        if (type instanceof TypeWithEnhancement) {
            ...
            if (projectedTypeForConflictedTypeWithUnsafeVariance == null && FlexibleTypesKt.isFlexible(type) && !TypeCapabilitiesKt.isCustomTypeVariable(type)) {
                ...
                if (!CapturedTypeConstructorKt.isCaptured(type)) {
                    int i3 = C33662.f1300x4790888d[conflictType.ordinal()];
                    if (i3 == 1) {
    ...
    static /* synthetic */ class C33662 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f1300x4790888d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f1300x4790888d     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.TypeSubstitutor.C33662.<clinit>():void");
        }
    }
    ...
    private List<TypeProjection> substituteTypeArguments(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i) throws SubstitutionException {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            int i3 = C33662.f1300x4790888d[conflictType(typeParameterDescriptor.getVariance(), unsafeSubstitute.getProjectionKind()).ordinal()];
            if (i3 == 1 || i3 == 2) {
