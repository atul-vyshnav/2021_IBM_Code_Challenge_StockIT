...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    private final LazyJavaAnnotations annotations = new LazyJavaAnnotations(this.f1282c, this.javaTypeParameter, false, 4, (DefaultConstructorMarker) null);

    /* renamed from: c */
    private final LazyJavaResolverContext f1282c;
    ...
    public LazyJavaTypeParameterDescriptor(kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r17, kotlin.reflect.jvm.internal.impl.load.java.structure.JavaTypeParameter r18, int r19, kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor r20) {
        /*
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r11 = r9.f1282c
    ...
    private final List<KotlinType> computeNotEnhancedBounds() {
        ...
        if (upperBounds.isEmpty()) {
            ...
            SimpleType anyType = this.f1282c.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkNotNullExpressionValue(anyType, "c.module.builtIns.anyType");
            SimpleType nullableAnyType = this.f1282c.getModule().getBuiltIns().getNullableAnyType();
        ...
        for (JavaClassifierType transformJavaType : iterable) {
            arrayList.add(this.f1282c.getTypeResolver().transformJavaType(transformJavaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, this, 1, (Object) null)));
        }
    ...
    public List<KotlinType> processBoundsWithoutCycles(List<? extends KotlinType> list) {
        ...
        return this.f1282c.getComponents().getSignatureEnhancement().enhanceTypeParameterBounds(this, list, this.f1282c);
    }
}
