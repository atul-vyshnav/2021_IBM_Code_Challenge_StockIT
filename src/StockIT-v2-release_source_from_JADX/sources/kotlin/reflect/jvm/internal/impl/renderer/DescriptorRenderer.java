...
public abstract class DescriptorRenderer {
    ...
    public static final DescriptorRenderer FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = Companion.withOptions(C3321xb65db377.INSTANCE);
    ...
    public interface ValueParametersHandler {
        ...
        public static final class DEFAULT implements ValueParametersHandler {
            ...
            public void appendBeforeValueParameter(ValueParameterDescriptor valueParameterDescriptor, int i, int i2, StringBuilder sb) {
                Intrinsics.checkNotNullParameter(valueParameterDescriptor, MediationRewardedVideoAdAdapter.CUSTOM_EVENT_SERVER_PARAMETER_FIELD);
