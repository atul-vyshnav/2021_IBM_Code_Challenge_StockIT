...
public abstract class AbstractBinaryClassAnnotationAndConstantLoader<A, C> implements AnnotationAndConstantLoader<A, C> {
    ...
    public List<A> loadClassAnnotations(ProtoContainer.Class classR) {
        ...
        if (binaryClass != null) {
            ...
            binaryClass.loadClassAnnotations(new C3250xc0ff27f9(this, arrayList), getCachedFileContent(binaryClass));
            return arrayList;
        }
    ...
    public final Storage<A, C> loadAnnotationsAndInitializers(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        kotlinJvmBinaryClass.visitMembers(new C3249x2cf49cf1(this, hashMap, hashMap2), getCachedFileContent(kotlinJvmBinaryClass));
