...
final class C3227xb25049f1 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JUStream;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C3227xb25049f1(String str) {
        super(1);
        this.$JUStream = str;
    }
