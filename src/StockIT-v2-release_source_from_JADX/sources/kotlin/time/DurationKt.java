...
public final class DurationKt {
    ...
    private static final double m2526timesmvk6XK0(int i, double d) {
        return Duration.m2506timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m2525timeskIfJnKk(double d, double d2) {
        return Duration.m2505timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m2479constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
