...
public class DateFormatUtils {
    ...
    static {
        ...
        FastDateFormat instance3 = FastDateFormat.getInstance(ParametersConverter.PROTOCOL_DATE_FORMAT);
        ISO_8601_EXTENDED_DATE_FORMAT = instance3;
        ISO_DATE_FORMAT = instance3;
        FastDateFormat instance4 = FastDateFormat.getInstance(ParametersConverter.PROTOCOL_TIME_FORMAT);
