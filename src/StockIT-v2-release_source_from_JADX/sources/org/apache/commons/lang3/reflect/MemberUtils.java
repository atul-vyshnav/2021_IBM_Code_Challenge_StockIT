...
abstract class MemberUtils {
    ...
    static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m1188of(constructor), Executable.m1188of(constructor2), clsArr);
    }

    static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m1189of(method), Executable.m1189of(method2), clsArr);
    }
    ...
    static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m1189of(method), clsArr);
    }

    static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m1188of(constructor), clsArr);
    }
    ...
    private static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m1189of(Method method) {
            return new Executable(method);
        }

        /* access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m1188of(Constructor<?> constructor) {
