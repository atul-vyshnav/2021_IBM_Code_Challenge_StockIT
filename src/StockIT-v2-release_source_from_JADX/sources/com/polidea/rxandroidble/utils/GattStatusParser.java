...
public class GattStatusParser {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(TsExtractor.TS_STREAM_TYPE_E_AC3), "GATT_ILLEGAL_PARAMETER");
        hashMap.put(128, "GATT_NO_RESOURCES");
        hashMap.put(Integer.valueOf(TsExtractor.TS_STREAM_TYPE_AC3), "GATT_INTERNAL_ERROR");
        hashMap.put(Integer.valueOf(TsExtractor.TS_STREAM_TYPE_HDMV_DTS), "GATT_WRONG_STATE");
        hashMap.put(131, "GATT_DB_FULL");
        hashMap.put(132, "GATT_BUSY");
        hashMap.put(133, "GATT_ERROR");
        hashMap.put(Integer.valueOf(TsExtractor.TS_STREAM_TYPE_SPLICE_INFO), "GATT_CMD_STARTED");
        hashMap.put(136, "GATT_PENDING");
        hashMap.put(137, "GATT_AUTH_FAIL");
        hashMap.put(Integer.valueOf(TsExtractor.TS_STREAM_TYPE_DTS), "GATT_MORE");
