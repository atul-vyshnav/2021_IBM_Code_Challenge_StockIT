...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        ...
        int i = C07351.f45x7df623d1[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
    ...
    static /* synthetic */ class C07351 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f45x7df623d1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f45x7df623d1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f45x7df623d1     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f45x7df623d1     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.animation.content.MergePathsContent.C07351.<clinit>():void");
        }
    }
