        ...
        while (true) {
            ...
            if (forModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C07411.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer2 = forModel;
                    }
                }
    ...
    static /* synthetic */ class C07411 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.CompositionLayer.C07411.<clinit>():void");
        }
    }

    /* access modifiers changed from: package-private */
    public void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C0692L.beginSection("CompositionLayer#draw");
        ...
        if (z) {
            ...
            C0749Utils.saveLayerCompat(canvas, this.newClipRect, this.layerPaint);
        } else {
            canvas.save();
        }
        if (z) {
        ...
        canvas.restore();
        C0692L.endSection("CompositionLayer#draw");
    }
