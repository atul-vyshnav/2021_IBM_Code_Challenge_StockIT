...
public class LayerParser {
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m21of("nm");
    private static final JsonReader.Options NAMES = JsonReader.Options.m21of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", TtmlNode.TAG_TT, "masksProperties", "shapes", "t", "ef", "sr", "st", "w", "h", "ip", "op", "tm", "cl", "hd");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m21of("d", NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY);
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader2.selectName(NAMES)) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    i = (int) (((float) jsonReader.nextInt()) * C0749Utils.dpScale());
                    break;
                case 6:
                    i2 = (int) (((float) jsonReader.nextInt()) * C0749Utils.dpScale());
                    break;
                case 7:
                ...
                case 15:
                    ...
                    break;
                case 16:
                    i4 = (int) (((float) jsonReader.nextInt()) * C0749Utils.dpScale());
                    break;
                case 17:
                    i5 = (int) (((float) jsonReader.nextInt()) * C0749Utils.dpScale());
                    break;
                case 18:
