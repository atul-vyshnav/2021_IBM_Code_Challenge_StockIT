...
class GradientStrokeParser {
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.m21of(NotificationBundleProcessor.PUSH_MINIFIED_BUTTON_TEXT, "v");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m21of("p", "k");
    private static JsonReader.Options NAMES = JsonReader.Options.m21of("nm", "g", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
