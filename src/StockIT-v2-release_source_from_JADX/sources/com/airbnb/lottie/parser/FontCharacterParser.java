...
class FontCharacterParser {
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m21of("shapes");
    private static final JsonReader.Options NAMES = JsonReader.Options.m21of("ch", "size", "w", TtmlNode.TAG_STYLE, "fFamily", "data");
