...
public class LottieCompositionFactory {
    ...
    private static LottieResult<LottieComposition> fromJsonInputStreamSync(InputStream inputStream, String str, boolean z) {
        try {
            return fromJsonReaderSync(JsonReader.m20of(Okio.buffer(Okio.source(inputStream))), str);
        } finally {
            if (z) {
                C0749Utils.closeQuietly(inputStream);
            }
        }
    }
    ...
    public static LottieResult<LottieComposition> fromJsonStringSync(String str, String str2) {
        return fromJsonReaderSync(JsonReader.m20of(Okio.buffer(Okio.source((InputStream) new ByteArrayInputStream(str.getBytes())))), str2);
    }
    ...
    private static LottieResult<LottieComposition> fromJsonReaderSyncInternal(JsonReader jsonReader, String str, boolean z) {
        try {
            ...
            if (z) {
                C0749Utils.closeQuietly(jsonReader);
            }
            return lottieResult;
        } catch (Exception e) {
    ...
    public static LottieResult<LottieComposition> fromZipStreamSync(ZipInputStream zipInputStream, String str) {
        try {
            ...
            C0749Utils.closeQuietly(zipInputStream);
        }
    }
        ...
        try {
            ...
            while (nextEntry != null) {
                ...
                if (name.contains("__MACOSX")) {
                    ...
                    lottieComposition = fromJsonReaderSyncInternal(JsonReader.m20of(Okio.buffer(Okio.source((InputStream) zipInputStream))), (String) null, false).getValue();
                } else {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                if (findImageAssetForFileName != null) {
                    findImageAssetForFileName.setBitmap(C0749Utils.resizeBitmapIfNeeded((Bitmap) entry.getValue(), findImageAssetForFileName.getWidth(), findImageAssetForFileName.getHeight()));
                }
            }
