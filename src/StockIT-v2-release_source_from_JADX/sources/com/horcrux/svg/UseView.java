...
class UseView extends RenderableView {
    ...
    /* renamed from: mH */
    private SVGLength f1157mH;
    private String mHref;

    /* renamed from: mW */
    private SVGLength f1158mW;

    /* renamed from: mX */
    private SVGLength f1159mX;

    /* renamed from: mY */
    private SVGLength f1160mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f1159mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f1160mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f1158mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f1157mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public void draw(Canvas canvas, Paint paint, float f) {
        ...
        if (definedTemplate == null) {
            FLog.m104w(ReactConstants.TAG, "`Use` element expected a pre-defined svg template as `href` prop, template named: " + this.mHref + " is not defined.");
            return;
        }
        definedTemplate.clearCache();
        canvas.translate((float) relativeOnWidth(this.f1159mX), (float) relativeOnHeight(this.f1160mY));
        ...
        if (definedTemplate instanceof SymbolView) {
            ((SymbolView) definedTemplate).drawSymbol(canvas, paint, f, (float) relativeOnWidth(this.f1158mW), (float) relativeOnHeight(this.f1157mH));
        } else {
    ...
    public Path getPath(Canvas canvas, Paint paint) {
        ...
        matrix.setTranslate((float) relativeOnWidth(this.f1159mX), (float) relativeOnHeight(this.f1160mY));
