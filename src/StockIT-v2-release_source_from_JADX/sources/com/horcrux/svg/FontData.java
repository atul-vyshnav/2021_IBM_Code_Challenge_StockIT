...
class FontData {
    ...
    FontData(ReadableMap readableMap, FontData fontData2, double d) {
        ...
        this.textDecoration = readableMap.hasKey("textDecoration") ? TextProperties.TextDecoration.getEnum(readableMap.getString("textDecoration")) : fontData2.textDecoration;
