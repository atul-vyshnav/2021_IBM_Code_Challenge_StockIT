...
class PatternView extends GroupView {
    ...
    /* renamed from: mW */
    private SVGLength f1139mW;

    /* renamed from: mX */
    private SVGLength f1140mX;

    /* renamed from: mY */
    private SVGLength f1141mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f1140mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f1141mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f1139mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f1138mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    public void saveDefinition() {
        if (this.mName != null) {
            Brush brush = new Brush(Brush.BrushType.PATTERN, new SVGLength[]{this.f1140mX, this.f1141mY, this.f1139mW, this.f1138mH}, this.mPatternUnits);
