...
public abstract class RenderableView extends VirtualView {
    ...
    public void setFill(@Nullable Dynamic dynamic) {
        ...
        if (type.equals(ReadableType.Number)) {
            this.fill = JavaOnlyArray.m137of(0, Integer.valueOf(dynamic.asInt()));
    ...
    public void setStroke(@Nullable Dynamic dynamic) {
        ...
        int i = 0;
        if (type.equals(ReadableType.Number)) {
            this.stroke = JavaOnlyArray.m137of(0, Integer.valueOf(dynamic.asInt()));
        } else if (type.equals(ReadableType.Array)) {
    ...
    public void render(Canvas canvas, Paint paint, float f) {
        ...
        if (maskView != null) {
            ...
            int i = width;
            canvas3.clipRect((float) relativeOnWidth(maskView.f1133mX), (float) relativeOnHeight(maskView.f1134mY), (float) relativeOnWidth(maskView.f1132mW), (float) relativeOnHeight(maskView.f1131mH));
    ...
    public void renderMarkers(Canvas canvas, Paint paint, float f) {
        ...
        if (markerView != null || markerView2 != null || markerView3 != null) {
            ...
            while (it.hasNext()) {
                ...
                int i = C22471.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[next.type.ordinal()];
    ...
    static /* synthetic */ class C22471 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.RenderableView.C22471.<clinit>():void");
        }
    }
