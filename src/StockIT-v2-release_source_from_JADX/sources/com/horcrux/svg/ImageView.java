...
class ImageView extends RenderableView {
    ...
    /* renamed from: mW */
    private SVGLength f1128mW;

    /* renamed from: mX */
    private SVGLength f1129mX;

    /* renamed from: mY */
    private SVGLength f1130mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f1129mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "y")
    public void setY(Dynamic dynamic) {
        this.f1130mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f1128mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f1127mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    private void loadBitmap(ImagePipeline imagePipeline, ImageRequest imageRequest) {
        ...
        imagePipeline.fetchDecodedImage(imageRequest, this.mContext).subscribe(new BaseBitmapDataSubscriber() {
            ...
            public void onFailureImpl(DataSource dataSource) {
                ImageView.this.mLoading.set(false);
                FLog.m107w(ReactConstants.TAG, dataSource.getFailureCause(), "RNSVG: fetchDecodedImage failed!", new Object[0]);
            }
    ...
    private RectF getRect() {
        double relativeOnWidth = relativeOnWidth(this.f1129mX);
        double relativeOnHeight = relativeOnHeight(this.f1130mY);
        double relativeOnWidth2 = relativeOnWidth(this.f1128mW);
        double relativeOnHeight2 = relativeOnHeight(this.f1127mH);
