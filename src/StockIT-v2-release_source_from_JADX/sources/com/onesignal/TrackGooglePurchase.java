...
class TrackGooglePurchase {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Bundle bundle = (Bundle) TrackGooglePurchase.this.getPurchasesMethod.invoke(TrackGooglePurchase.this.mIInAppBillingService, new Object[]{3, TrackGooglePurchase.this.appContext.getPackageName(), BillingClient.SkuType.INAPP, null});
    ...
    public void sendPurchases(ArrayList<String> arrayList, final ArrayList<String> arrayList2) {
        try {
            ...
            Bundle bundle2 = (Bundle) this.getSkuDetailsMethod.invoke(this.mIInAppBillingService, new Object[]{3, this.appContext.getPackageName(), BillingClient.SkuType.INAPP, bundle});
