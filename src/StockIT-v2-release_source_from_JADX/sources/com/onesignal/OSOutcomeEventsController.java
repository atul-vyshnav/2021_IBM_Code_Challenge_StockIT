...
class OSOutcomeEventsController {
    ...
    private void sendAndCreateOutcomeEvent(String str, float f, List<OSInfluence> list, OneSignal.OutcomeCallback outcomeCallback) {
        ...
        for (OSInfluence next : list) {
            int i = C23455.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[next.getInfluenceType().ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.onesignal.OSOutcomeEventsController$5 */
    static /* synthetic */ class C23455 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$com$onesignal$influence$model$OSInfluenceChannel     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r1 = $SwitchMap$com$onesignal$influence$model$OSInfluenceType     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r0 = $SwitchMap$com$onesignal$influence$model$OSInfluenceType     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = $SwitchMap$com$onesignal$influence$model$OSInfluenceType     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.OSOutcomeEventsController.C23455.<clinit>():void");
        }
    }

    private OSOutcomeSourceBody setSourceChannelIds(OSInfluence oSInfluence, OSOutcomeSourceBody oSOutcomeSourceBody) {
        int i = C23455.$SwitchMap$com$onesignal$influence$model$OSInfluenceChannel[oSInfluence.getInfluenceChannel().ordinal()];
        if (i == 1) {
