...
class NotificationOpenedProcessor {
    ...
    static void processIntent(android.content.Context r8, android.content.Intent r9) {
        /*
            ...
            return
        L_0x0024:
            int r7 = r9.getIntExtra(r0, r4)     // Catch:{ JSONException -> 0x0040 }
        ...
        L_0x0054:
            markNotificationsConsumed(r8, r9, r0, r3)
            if (r2 != 0) goto L_0x0064
            java.lang.String r1 = "grp"
            java.lang.String r1 = r9.getStringExtra(r1)
            if (r1 == 0) goto L_0x0064
            com.onesignal.NotificationSummaryManager.updateSummaryNotificationAfterChildRemoved(r8, r0, r1, r3)
        L_0x0064:
