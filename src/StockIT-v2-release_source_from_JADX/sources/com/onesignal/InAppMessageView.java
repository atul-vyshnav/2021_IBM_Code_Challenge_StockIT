...
class InAppMessageView {
    ...
    private LinearLayout.LayoutParams createParentLinearLayoutParams() {
        ...
        int i = C23229.$SwitchMap$com$onesignal$WebViewManager$Position[this.displayLocation.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C23229 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.InAppMessageView.C23229.<clinit>():void");
        }
    }
    ...
    public DraggableRelativeLayout.Params createDraggableLayoutParams(int i, WebViewManager.Position position) {
        ...
        int i2 = C23229.$SwitchMap$com$onesignal$WebViewManager$Position[position.ordinal()];
        int i3 = 1;
        if (i2 == 1) {
    ...
    public void createPopupWindow(RelativeLayout relativeLayout) {
        ...
        if (!this.hasBackground) {
            int i4 = C23229.$SwitchMap$com$onesignal$WebViewManager$Position[this.displayLocation.ordinal()];
            if (i4 == 1) {
                i = 49;
            } else if (i4 == 2) {
                i = 81;
    ...
    public void animateInAppMessage(WebViewManager.Position position, View view, View view2) {
        ...
        int i = C23229.$SwitchMap$com$onesignal$WebViewManager$Position[position.ordinal()];
        if (i == 1) {
