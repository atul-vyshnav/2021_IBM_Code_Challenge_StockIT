...
class LocationController {
    ...
    static class LocationPoint {
        ...
        public String toString() {
            return "LocationPoint{lat=" + this.lat + ", log=" + this.log + ", accuracy=" + this.accuracy + ", type=" + this.type + ", bg=" + this.f1167bg + ", timeStamp=" + this.timeStamp + '}';
        }
    }
    ...
    protected static void fireCompleteForLocation(Location location) {
        ...
        locationPoint.f1167bg = Boolean.valueOf(OneSignal.isForeground() ^ true);
