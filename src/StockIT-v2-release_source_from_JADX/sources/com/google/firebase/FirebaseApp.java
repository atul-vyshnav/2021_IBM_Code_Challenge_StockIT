...
public class FirebaseApp {
    ...
    private FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        List<ComponentRegistrar> zza2 = Component.C21171.zza(context).zza();
        zzf zzf2 = new zzf(zzh, zza2, Component.m1109of(context, Context.class, new Class[0]), Component.m1109of(this, FirebaseApp.class, new Class[0]), Component.m1109of(firebaseOptions, FirebaseOptions.class, new Class[0]));
        this.zzl = zzf2;
