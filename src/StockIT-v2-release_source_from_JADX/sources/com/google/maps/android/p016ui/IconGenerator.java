...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(this.mContext).inflate(C2202R.layout.amu_text_bubble, (ViewGroup) null);
        this.mContainer = viewGroup;
        RotationLayout rotationLayout = (RotationLayout) viewGroup.getChildAt(0);
        this.mRotationLayout = rotationLayout;
        TextView textView = (TextView) rotationLayout.findViewById(C2202R.C2205id.amu_text);
    ...
    public void setContentView(View view) {
        ...
        View findViewById = this.mRotationLayout.findViewById(C2202R.C2205id.amu_text);
    ...
    private static int getTextStyle(int i) {
        if (i == 3 || i == 4 || i == 5 || i == 6 || i == 7) {
            return C2202R.style.amu_Bubble_TextAppearance_Light;
        }
        return C2202R.style.amu_Bubble_TextAppearance_Dark;
    }
}
