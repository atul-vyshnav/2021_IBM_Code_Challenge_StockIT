...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(Point point) {
        return new LatLng(90.0d - Math.toDegrees(Math.atan(Math.exp(((-(0.5d - (point.f1089y / this.mWorldWidth))) * 2.0d) * 3.141592653589793d)) * 2.0d), ((point.f1088x / this.mWorldWidth) - 0.5d) * 360.0d);
    }
}
