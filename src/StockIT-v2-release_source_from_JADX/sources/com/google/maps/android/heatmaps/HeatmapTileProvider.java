...
public class HeatmapTileProvider implements TileProvider {
    ...
    public com.google.android.gms.maps.model.Tile getTile(int r37, int r38, int r39) {
        ...
        L_0x00e1:
            ...
            double r11 = r10.f1088x
            double r11 = r11 - r17
            double r11 = r11 / r6
            int r11 = (int) r11
            double r12 = r10.f1089y
            double r12 = r12 - r8
            double r12 = r12 / r6
            int r10 = (int) r12
            r11 = r2[r11]
        ...
        L_0x010c:
            ...
            double r10 = r5.f1088x
            double r10 = r10 + r25
            double r10 = r10 - r17
            double r10 = r10 / r6
            int r10 = (int) r10
            double r11 = r5.f1089y
            double r11 = r11 - r8
            double r11 = r11 / r6
            int r5 = (int) r11
            r10 = r2[r10]
    ...
    static Bounds getBounds(Collection<WeightedLatLng> collection) {
        ...
        double d = next.getPoint().f1088x;
        double d2 = next.getPoint().f1088x;
        double d3 = d;
        double d4 = d2;
        double d5 = next.getPoint().f1089y;
        double d6 = next.getPoint().f1089y;
        while (it.hasNext()) {
            WeightedLatLng next2 = it.next();
            double d7 = next2.getPoint().f1088x;
            double d8 = next2.getPoint().f1089y;
            if (d7 < d3) {
                d3 = d7;
            }
            if (d7 > d4) {
    ...
    static double getMaxValue(Collection<WeightedLatLng> collection, Bounds bounds, int i, int i2) {
        ...
        for (WeightedLatLng next : collection) {
            double d8 = next.getPoint().f1088x;
            int i3 = (int) ((next.getPoint().f1089y - d3) * d6);
