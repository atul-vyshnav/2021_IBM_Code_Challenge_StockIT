...
public final class C1985h {
    /* renamed from: a */
    private static int m778a(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: a */
    public static long m779a(ByteBuffer byteBuffer) {
        m796c(byteBuffer);
        return m780a(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: a */
    private static long m780a(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & 4294967295L;
    }

    /* renamed from: a */
    static Pair<ByteBuffer, Long> m781a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> a = m782a(randomAccessFile, 0);
        return a != null ? a : m782a(randomAccessFile, 65535);
    }

    /* renamed from: a */
    private static Pair<ByteBuffer, Long> m782a(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
    ...
    /* renamed from: a */
    public static String m783a(String str, String str2) {
    ...
    /* renamed from: a */
    public static String m784a(String str, String str2, String str3) {
    ...
    /* renamed from: a */
    private static void m785a(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
    ...
    /* renamed from: a */
    public static void m786a(ByteBuffer byteBuffer, long j) {
        m796c(byteBuffer);
    ...
    /* renamed from: a */
    private static void m787a(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C1966c cVar = new C1966c(fileChannel, 0, j);
            C1966c cVar2 = new C1966c(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m786a(duplicate, j);
            C1912a aVar = new C1912a(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] a = m789a(iArr, new C1939b[]{cVar, cVar2, aVar});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), a[i])) {
                        ...
                        throw new SecurityException(m793b(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    private static java.security.cert.X509Certificate[] m788a(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m797d(r22)
            java.nio.ByteBuffer r1 = m797d(r22)
            byte[] r2 = m798e(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m797d(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m778a((int) r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m778a((int) r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m798e(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m797d(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m797d(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m798e(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x0278:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C1985h.m788a(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: a */
    private static byte[][] m789a(int[] iArr, C1939b[] bVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (bVarArr[i2].mo34131a() + 1048575) / 1048576;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m795c(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m785a(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C1939b bVar = bVarArr[i6];
                long j4 = j2;
                int i9 = i6;
                long a = bVar.mo34131a();
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        bVar.mo34132a(messageDigestArr, j5, min);
                        int i11 = 0;
    ...
    /* renamed from: a */
    public static X509Certificate[][] m790a(String str) throws C1982e, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m781a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C1982e("ZIP64 APK not supported");
                    }
                }
                long a2 = m779a(byteBuffer2);
                if (a2 >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C1982e(sb.toString());
                } else if (m792b(byteBuffer2) + a2 != longValue) {
                    throw new C1982e("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (a2 >= 32) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        throw new C1982e(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] a3 = m791a(randomAccessFile.getChannel(), new C1981d(m794b(slice, i4 - 4), longValue2, a2, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i2);
                                                    throw new C1982e(sb5.toString());
                                                }
                                            }
                                            throw new C1982e("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C1982e(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: a */
    private static X509Certificate[][] m791a(FileChannel fileChannel, C1981d dVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer d = m797d(dVar.f826a);
                int i = 0;
                while (d.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m788a(m797d(d), (Map<Integer, byte[]>) hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m787a(hashMap, fileChannel, dVar.f827b, dVar.f828c, dVar.f829d, dVar.f830e);
    ...
    /* renamed from: b */
    public static long m792b(ByteBuffer byteBuffer) {
        m796c(byteBuffer);
        return m780a(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: b */
    private static String m793b(int i) {
        if (i == 1) {
    ...
    /* renamed from: b */
    private static ByteBuffer m794b(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: c */
    private static int m795c(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: c */
    private static void m796c(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }
    ...
    /* renamed from: d */
    private static ByteBuffer m797d(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m794b(byteBuffer, i);
            } else {
    ...
    /* renamed from: e */
    private static byte[] m798e(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
