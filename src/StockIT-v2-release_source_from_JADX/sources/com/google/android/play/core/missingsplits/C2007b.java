...
final class C2007b implements MissingSplitsManager {

    /* renamed from: a */
    private static final C1918af f846a = new C1918af("MissingSplitsManagerImpl");

    /* renamed from: b */
    private final Context f847b;

    /* renamed from: c */
    private final Runtime f848c;

    /* renamed from: d */
    private final C2006a f849d;

    /* renamed from: e */
    private final AtomicReference<Boolean> f850e;

    C2007b(Context context, Runtime runtime, C2006a aVar, AtomicReference<Boolean> atomicReference) {
        this.f847b = context;
        this.f848c = runtime;
        this.f849d = aVar;
        this.f850e = atomicReference;
    }

    /* renamed from: a */
    private final boolean m873a() {
        try {
            ApplicationInfo applicationInfo = this.f847b.getPackageManager().getApplicationInfo(this.f847b.getPackageName(), 128);
            ...
            f846a.mo34143d("App '%s' is not found in the PackageManager", this.f847b.getPackageName());
            return false;
        }
    }

    /* renamed from: a */
    private static boolean m874a(Set<String> set) {
        return set.isEmpty() || (set.size() == 1 && set.contains(""));
    }

    /* renamed from: b */
    private final Set<String> m875b() {
        if (Build.VERSION.SDK_INT < 21) {
            return Collections.emptySet();
        }
        try {
            PackageInfo packageInfo = this.f847b.getPackageManager().getPackageInfo(this.f847b.getPackageName(), 0);
            ...
            f846a.mo34143d("App '%s' is not found in PackageManager", this.f847b.getPackageName());
            return Collections.emptySet();
        }
    }

    /* renamed from: c */
    private final List<ActivityManager.AppTask> m876c() {
        List<ActivityManager.AppTask> appTasks = ((ActivityManager) this.f847b.getSystemService("activity")).getAppTasks();
        return appTasks != null ? appTasks : Collections.emptyList();
    }

    /* JADX WARNING: Can't wrap try/catch for region: R(2:29|30) */
    /* JADX WARNING: Code restructure failed: missing block: B:30:?, code lost:
        f846a.mo34143d("App '%s' is not found in PackageManager", r8.f847b.getPackageName());
     */
    ...
    public final boolean disableAppIfMissingRequiredSplits() {
        /*
            ...
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r0 = r8.f850e
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r3 = r8.f850e     // Catch:{ all -> 0x01cf }
        ...
        L_0x001b:
            ...
            goto L_0x00ac
        L_0x001e:
            android.content.Context r5 = r8.f847b     // Catch:{ all -> 0x01cf }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x01cf }
            android.content.Context r6 = r8.f847b     // Catch:{ NameNotFoundException -> 0x0099 }
        ...
        L_0x004a:
            ...
            goto L_0x0083
        L_0x004f:
            android.content.Context r1 = r8.f847b     // Catch:{ NameNotFoundException -> 0x0071 }
            android.content.pm.PackageManager r1 = r1.getPackageManager()     // Catch:{ NameNotFoundException -> 0x0071 }
            android.content.Context r5 = r8.f847b     // Catch:{ NameNotFoundException -> 0x0071 }
        ...
        L_0x006f:
            ...
            goto L_0x0083
        L_0x0071:
            com.google.android.play.core.internal.af r1 = f846a     // Catch:{ all -> 0x01cf }
            java.lang.Object[] r5 = new java.lang.Object[r4]     // Catch:{ all -> 0x01cf }
            android.content.Context r6 = r8.f847b     // Catch:{ all -> 0x01cf }
            ...
            r1.mo34143d(r6, r5)     // Catch:{ all -> 0x01cf }
            goto L_0x004a
        L_0x0083:
        ...
        L_0x00b3:
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r1 = r8.f850e     // Catch:{ all -> 0x01cf }
        ...
        L_0x0154:
            ...
            goto L_0x0140
        L_0x0156:
            com.google.android.play.core.internal.af r5 = f846a
            java.lang.Object[] r6 = new java.lang.Object[r4]
            r6[r2] = r3
            java.lang.String r3 = "ClassNotFoundException when scanning class hierarchy of '%s'"
            r5.mo34143d(r3, r6)
            android.content.Context r3 = r8.f847b     // Catch:{ NameNotFoundException -> 0x016e }
        ...
        L_0x0170:
            r0 = 0
        L_0x0171:
            com.google.android.play.core.missingsplits.a r1 = r8.f849d
            r1.mo34256b()
            java.util.List r1 = r8.m876c()
        ...
        L_0x018e:
            ...
            android.content.Context r0 = r8.f847b
            android.content.pm.PackageManager r0 = r0.getPackageManager()
            android.content.ComponentName r1 = new android.content.ComponentName
            android.content.Context r3 = r8.f847b
            ...
            android.content.Context r1 = r8.f847b
            java.lang.Class<com.google.android.play.core.missingsplits.PlayCoreMissingSplitsActivity> r3 = com.google.android.play.core.missingsplits.PlayCoreMissingSplitsActivity.class
            r0.<init>(r1, r3)
            ...
            r1.startActivity(r0)
        L_0x01b6:
            java.lang.Runtime r0 = r8.f848c
            r0.exit(r2)
        L_0x01bb:
            return r4
        L_0x01bc:
            com.google.android.play.core.missingsplits.a r0 = r8.f849d
            boolean r0 = r0.mo34255a()
        ...
        L_0x01d2:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.missingsplits.C2007b.disableAppIfMissingRequiredSplits():boolean");
    }

    public final boolean isMissingRequiredSplits() {
        boolean booleanValue;
        synchronized (this.f850e) {
            if (this.f850e.get() == null) {
                AtomicReference<Boolean> atomicReference = this.f850e;
                boolean z = false;
                if (Build.VERSION.SDK_INT >= 21) {
                    if (m873a() && m874a(m875b())) {
                        z = true;
                    }
                }
                atomicReference.set(Boolean.valueOf(z));
            }
            booleanValue = this.f850e.get().booleanValue();
        }
        return booleanValue;
    }
}
