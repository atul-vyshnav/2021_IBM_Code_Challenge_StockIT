...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C1577R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C1577R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C1577R.attr.colorSurface, 0);
