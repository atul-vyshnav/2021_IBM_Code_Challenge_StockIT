...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C1577R.attr.snackbarStyle};
    ...
    private Drawable createThemedBackground() {
        int layer = MaterialColors.layer(this.view, C1577R.attr.colorSurface, C1577R.attr.colorOnSurface, this.view.getBackgroundOverlayColorAlpha());
        float dimension = this.view.getResources().getDimension(C1577R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1577R.layout.mtrl_layout_snackbar : C1577R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1577R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C1577R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C1577R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C1577R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C1577R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C1577R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            obtainStyledAttributes.recycle();
