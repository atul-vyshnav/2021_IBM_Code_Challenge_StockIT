...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1577R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C1577R.style.Widget_MaterialComponents_Chip_Action);
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1577R.styleable.Chip, i, C1577R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        if (Build.VERSION.SDK_INT < 23) {
            setTextColor(MaterialResources.getColorStateList(context, obtainStyledAttributes, C1577R.styleable.Chip_android_textColor));
        }
        boolean hasValue = obtainStyledAttributes.hasValue(C1577R.styleable.Chip_shapeAppearance);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1577R.styleable.Chip, i, C1577R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C1577R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil((double) obtainStyledAttributes.getDimension(C1577R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
        obtainStyledAttributes.recycle();
    }
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C1577R.string.mtrl_chip_close_icon_content_description;
