...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1577R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1577R.attr.extendedFloatingActionButtonStyle);
    }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1577R.styleable.ExtendedFloatingActionButton, i, DEF_STYLE_RES, new int[0]);
        MotionSpec createFromAttribute = MotionSpec.createFromAttribute(context, obtainStyledAttributes, C1577R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec createFromAttribute2 = MotionSpec.createFromAttribute(context, obtainStyledAttributes, C1577R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec createFromAttribute3 = MotionSpec.createFromAttribute(context, obtainStyledAttributes, C1577R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec createFromAttribute4 = MotionSpec.createFromAttribute(context, obtainStyledAttributes, C1577R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1577R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C1577R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = obtainStyledAttributes.getBoolean(C1577R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            obtainStyledAttributes.recycle();
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1577R.C1578animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1577R.C1578animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1577R.C1578animator.mtrl_extended_fab_hide_motion_spec;
        }
