...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1577R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1577R.C1580drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1577R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1577R.C1581id.icon);
        this.smallLabel = (TextView) findViewById(C1577R.C1581id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1577R.C1581id.largeLabel);
