...
public final class DownloadManager {
    ...
    public int handleAction(DownloadAction downloadAction) {
        ...
        return addTaskForAction.f137id;
    }
    ...
    public /* synthetic */ void lambda$loadActions$1$DownloadManager() {
        ...
        try {
            ...
            Log.m170e(TAG, "Action file loading failed.", th);
            downloadActionArr = new DownloadAction[0];
        }
        this.handler.post(new Runnable(downloadActionArr) {
    ...
    public /* synthetic */ void lambda$saveActions$2$DownloadManager(DownloadAction[] downloadActionArr) {
        try {
            this.actionFile.store(downloadActionArr);
            logd("Actions persisted.");
        } catch (IOException e) {
            Log.m170e(TAG, "Persisting actions failed.", e);
        }
    }
    ...
    private static final class Task implements Runnable {
        ...
        public TaskState getDownloadState() {
            return new TaskState(this.f137id, this.action, getExternalState(), getDownloadPercentage(), getDownloadedBytes(), this.error);
        }
        ...
        public void cancel() {
            if (changeStateAndNotify(0, 5)) {
                this.downloadManager.handler.post(new Runnable() {
                    public final void run() {
                        DownloadManager.Task.this.lambda$cancel$0$DownloadManager$Task();
                    }
                });
        ...
        public void run() {
            ...
            this.downloadManager.handler.post(new Runnable(th) {
                ...
                public final void run() {
                    DownloadManager.Task.this.lambda$run$1$DownloadManager$Task(this.f$1);
                }
            });
        }
