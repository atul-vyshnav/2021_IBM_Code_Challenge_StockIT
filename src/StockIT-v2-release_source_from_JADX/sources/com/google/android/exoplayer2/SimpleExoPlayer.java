...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, Player.AudioComponent, Player.VideoComponent, Player.TextComponent {
    ...
    public void setVideoTextureView(TextureView textureView2) {
        ...
        if (textureView2.getSurfaceTextureListener() != null) {
            Log.m173w(TAG, "Replacing existing SurfaceTextureListener.");
        }
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView2 != null) {
            if (textureView2.getSurfaceTextureListener() != this.componentListener) {
                Log.m173w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void verifyApplicationThread() {
        if (Looper.myLooper() != getApplicationLooper()) {
            Log.m174w(TAG, "Player is accessed on the wrong thread. See https://google.github.io/ExoPlayer/faqs.html#what-do-player-is-accessed-on-the-wrong-thread-warnings-mean", this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
