...
final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, long j, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, MediaPeriodInfo mediaPeriodInfo) {
        ...
        this.uid = Assertions.checkNotNull(mediaPeriodInfo.f121id.periodUid);
        this.info = mediaPeriodInfo;
        this.sampleStreams = new SampleStream[rendererCapabilitiesArr.length];
        this.mayRetainStreamFlags = new boolean[rendererCapabilitiesArr.length];
        MediaPeriod createPeriod = mediaSource2.createPeriod(mediaPeriodInfo.f121id, allocator);
        this.mediaPeriod = mediaPeriodInfo.f121id.endPositionUs != Long.MIN_VALUE ? new ClippingMediaPeriod(createPeriod, true, 0, mediaPeriodInfo.f121id.endPositionUs) : createPeriod;
    }
