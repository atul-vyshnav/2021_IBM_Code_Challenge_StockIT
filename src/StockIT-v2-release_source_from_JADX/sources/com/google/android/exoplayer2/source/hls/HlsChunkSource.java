...
class HlsChunkSource {
    ...
    private long liveEdgeInPeriodTimeUs = C1379C.TIME_UNSET;
    ...
    public HlsChunkSource(HlsExtractorFactory hlsExtractorFactory, HlsPlaylistTracker hlsPlaylistTracker, HlsMasterPlaylist.HlsUrl[] hlsUrlArr, HlsDataSourceFactory hlsDataSourceFactory, TransferListener transferListener, TimestampAdjusterProvider timestampAdjusterProvider2, List<Format> list) {
    ...
    public void onChunkLoadCompleted(Chunk chunk) {
        if (chunk instanceof EncryptionKeyChunk) {
            ...
            setEncryptionData(encryptionKeyChunk.dataSpec.uri, encryptionKeyChunk.f145iv, encryptionKeyChunk.getResult());
        }
    }
    ...
    public boolean onPlaylistError(HlsMasterPlaylist.HlsUrl hlsUrl, long j) {
        ...
        if (j == C1379C.TIME_UNSET || this.trackSelection.blacklist(indexOf, j)) {
            return true;
        }
        return false;
    }
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        if (this.liveEdgeInPeriodTimeUs != C1379C.TIME_UNSET) {
