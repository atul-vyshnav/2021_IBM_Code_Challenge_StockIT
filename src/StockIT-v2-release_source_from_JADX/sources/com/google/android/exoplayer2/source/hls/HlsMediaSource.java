...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    private HlsMediaSource(Uri uri, HlsDataSourceFactory hlsDataSourceFactory, HlsExtractorFactory hlsExtractorFactory, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, HlsPlaylistTracker hlsPlaylistTracker, boolean z, Object obj) {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        long usToMs = hlsMediaPlaylist2.hasProgramDateTime ? C1379C.usToMs(hlsMediaPlaylist2.startTimeUs) : -9223372036854775807L;
        ...
        if (this.playlistTracker.isLive()) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(j3, usToMs, hlsMediaPlaylist2.durationUs, hlsMediaPlaylist2.durationUs, 0, j4 == C1379C.TIME_UNSET ? 0 : j4, true, false, this.tag);
        }
