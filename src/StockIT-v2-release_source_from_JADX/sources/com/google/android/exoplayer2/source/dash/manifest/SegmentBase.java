...
public abstract class SegmentBase {
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                return new RangedUri(urlTemplate.buildUri(representation.format.f120id, 0, representation.format.bitrate, 0), 0, -1);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = j2;
            return new RangedUri(this.mediaTemplate.buildUri(representation2.format.f120id, j, representation2.format.bitrate, j3), 0, -1);
        }
