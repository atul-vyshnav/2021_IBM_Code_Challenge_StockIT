...
public class PlayerView extends FrameLayout {
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i8 = C1490R.layout.exo_player_view;
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C1490R.styleable.PlayerView, 0, 0);
            try {
                boolean hasValue = obtainStyledAttributes.hasValue(C1490R.styleable.PlayerView_shutter_background_color);
                int color = obtainStyledAttributes.getColor(C1490R.styleable.PlayerView_shutter_background_color, 0);
                int resourceId = obtainStyledAttributes.getResourceId(C1490R.styleable.PlayerView_player_layout_id, i8);
                boolean z8 = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_use_artwork, true);
                int resourceId2 = obtainStyledAttributes.getResourceId(C1490R.styleable.PlayerView_default_artwork, 0);
                boolean z9 = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_use_controller, true);
                int i9 = obtainStyledAttributes.getInt(C1490R.styleable.PlayerView_surface_type, 1);
                int i10 = obtainStyledAttributes.getInt(C1490R.styleable.PlayerView_resize_mode, 0);
                int i11 = obtainStyledAttributes.getInt(C1490R.styleable.PlayerView_show_timeout, 5000);
                boolean z10 = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_hide_on_touch, true);
                boolean z11 = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_auto_show, true);
                int i12 = resourceId;
                i6 = obtainStyledAttributes.getInteger(C1490R.styleable.PlayerView_show_buffering, 0);
                boolean z12 = z10;
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z13 = obtainStyledAttributes.getBoolean(C1490R.styleable.PlayerView_hide_during_ads, true);
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = (AspectRatioFrameLayout) findViewById(C1490R.C1493id.exo_content_frame);
        this.contentFrame = aspectRatioFrameLayout;
        if (aspectRatioFrameLayout != null) {
            setResizeModeRaw(aspectRatioFrameLayout, i7);
        }
        View findViewById = findViewById(C1490R.C1493id.exo_shutter);
        ...
        this.overlayFrameLayout = (FrameLayout) findViewById(C1490R.C1493id.exo_overlay);
        ImageView imageView2 = (ImageView) findViewById(C1490R.C1493id.exo_artwork);
        this.artworkView = imageView2;
        this.useArtwork = z2 && imageView2 != null;
        if (i4 != 0) {
            this.defaultArtwork = ContextCompat.getDrawable(getContext(), i4);
        }
        SubtitleView subtitleView2 = (SubtitleView) findViewById(C1490R.C1493id.exo_subtitles);
        this.subtitleView = subtitleView2;
        if (subtitleView2 != null) {
            subtitleView2.setUserDefaultStyle();
            this.subtitleView.setUserDefaultTextSize();
        }
        View findViewById2 = findViewById(C1490R.C1493id.exo_buffering);
        this.bufferingView = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setVisibility(8);
        }
        this.showBuffering = i6;
        TextView textView = (TextView) findViewById(C1490R.C1493id.exo_error_message);
        this.errorMessageView = textView;
        if (textView != null) {
            textView.setVisibility(8);
        }
        PlayerControlView playerControlView = (PlayerControlView) findViewById(C1490R.C1493id.exo_controller);
        View findViewById3 = findViewById(C1490R.C1493id.exo_controller_placeholder);
    ...
    private static void configureEditModeLogoV23(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C1490R.C1492drawable.exo_edit_mode_logo, (Resources.Theme) null));
        imageView.setBackgroundColor(resources.getColor(C1490R.C1491color.exo_edit_mode_background_color, (Resources.Theme) null));
    }

    private static void configureEditModeLogo(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C1490R.C1492drawable.exo_edit_mode_logo));
        imageView.setBackgroundColor(resources.getColor(C1490R.C1491color.exo_edit_mode_background_color));
    }
