...
public final class AspectRatioFrameLayout extends FrameLayout {
    ...
    public AspectRatioFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1490R.styleable.AspectRatioFrameLayout, 0, 0);
            try {
                this.resizeMode = obtainStyledAttributes.getInt(C1490R.styleable.AspectRatioFrameLayout_resize_mode, 0);
            } finally {
