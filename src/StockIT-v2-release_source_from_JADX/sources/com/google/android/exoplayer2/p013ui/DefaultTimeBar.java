...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1490R.styleable.DefaultTimeBar, 0, 0);
            try {
                Drawable drawable = obtainStyledAttributes.getDrawable(C1490R.styleable.DefaultTimeBar_scrubber_drawable);
                ...
                this.barHeight = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_bar_height, dpToPx);
                this.touchTargetHeight = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_touch_target_height, dpToPx2);
                this.adMarkerWidth = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_ad_marker_width, dpToPx3);
                this.scrubberEnabledSize = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_scrubber_enabled_size, dpToPx4);
                this.scrubberDisabledSize = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_scrubber_disabled_size, dpToPx5);
                this.scrubberDraggedSize = obtainStyledAttributes.getDimensionPixelSize(C1490R.styleable.DefaultTimeBar_scrubber_dragged_size, dpToPx6);
                int i = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_played_color, -1);
                int i2 = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_scrubber_color, getDefaultScrubberColor(i));
                int i3 = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_buffered_color, getDefaultBufferedColor(i));
                int i4 = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_unplayed_color, getDefaultUnplayedColor(i));
                int i5 = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_ad_marker_color, DEFAULT_AD_MARKER_COLOR);
                int i6 = obtainStyledAttributes.getInt(C1490R.styleable.DefaultTimeBar_played_ad_marker_color, getDefaultPlayedAdMarkerColor(i5));
        ...
        this.duration = C1379C.TIME_UNSET;
        this.keyTimeIncrement = C1379C.TIME_UNSET;
    ...
    public void setDuration(long j) {
        this.duration = j;
        if (this.scrubbing && j == C1379C.TIME_UNSET) {
            stopScrubbing(true);
        }
        update();
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L_0x004d:
            ...
            com.google.android.exoplayer2.ui.TimeBar$OnScrubListener r0 = (com.google.android.exoplayer2.p013ui.TimeBar.OnScrubListener) r0
        ...
        L_0x0090:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p013ui.DefaultTimeBar.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public boolean onKeyDown(int r5, android.view.KeyEvent r6) {
        ...
        L_0x0036:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p013ui.DefaultTimeBar.onKeyDown(int, android.view.KeyEvent):boolean");
    }
    ...
    private long getScrubberPosition() {
        if (this.progressBar.width() <= 0 || this.duration == C1379C.TIME_UNSET) {
            return 0;
        }
