...
final class SubtitlePainter {
    ...
    private void setupTextLayout() {
        ...
        if (i9 <= 0) {
            Log.m173w(TAG, "Skipped drawing subtitle cue (insufficient space)");
            return;
        }
        ...
        if (f2 != Float.MIN_VALUE) {
            ...
            i2 = ((i5 - i13) / 2) + this.parentLeft;
            i = i2 + i13;
        }
        int i15 = i - i2;
        if (i15 <= 0) {
            Log.m173w(TAG, "Skipped drawing subtitle cue (invalid horizontal positioning)");
            return;
        }
