...
public class TrackSelectionView extends LinearLayout {
    ...
    public static Pair<AlertDialog, TrackSelectionView> getDialog(Activity activity, CharSequence charSequence, DefaultTrackSelector defaultTrackSelector, int i) {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C1490R.layout.exo_track_selection_dialog, (ViewGroup) null);
        TrackSelectionView trackSelectionView = (TrackSelectionView) inflate.findViewById(C1490R.C1493id.exo_track_selection_view);
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.disableView.setText(C1490R.string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C1490R.layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C1490R.string.exo_track_selection_auto);
