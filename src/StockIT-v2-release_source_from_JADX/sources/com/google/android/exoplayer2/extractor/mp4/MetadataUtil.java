...
final class MetadataUtil {
    ...
    private static final int TYPE_INTERNAL = Util.getIntegerCodeForString(InternalFrame.f134ID);
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        Log.m167d(TAG, "Skipped unknown metadata entry: " + Atom.getAtomTypeString(readInt));
        parsableByteArray.setPosition(position);
        return null;
    }
    ...
    private static TextInformationFrame parseTextAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        Log.m173w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static CommentFrame parseCommentAttribute(int i, ParsableByteArray parsableByteArray) {
        ...
        Log.m173w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static Id3Frame parseUint8Attribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (parseUint8AttributeValue < 0) {
            Log.m173w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i));
            return null;
        } else if (z) {
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        Log.m173w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static com.google.android.exoplayer2.metadata.id3.TextInformationFrame parseStandardGenreAttribute(com.google.android.exoplayer2.util.ParsableByteArray r3) {
        ...
        L_0x001c:
            ...
            com.google.android.exoplayer2.util.Log.m173w(r3, r1)
            return r0
        */
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == Atom.TYPE_data) {
            ...
            if (str == null) {
                Log.m173w(TAG, "Unrecognized cover art flags: " + parseFullAtomFlags);
                return null;
            }
        ...
        Log.m173w(TAG, "Failed to parse cover art attribute");
        return null;
    }
    ...
    private static int parseUint8AttributeValue(ParsableByteArray parsableByteArray) {
        ...
        Log.m173w(TAG, "Failed to parse uint8 attribute value");
        return -1;
    }
}
