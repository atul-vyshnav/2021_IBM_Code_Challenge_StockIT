...
public final class CacheUtil {
    ...
    private static long readAndDiscard(com.google.android.exoplayer2.upstream.DataSpec r17, long r18, long r20, com.google.android.exoplayer2.upstream.DataSource r22, byte[] r23, com.google.android.exoplayer2.util.PriorityTaskManager r24, int r25, com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters r26, java.util.concurrent.atomic.AtomicBoolean r27) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0008:
            ...
            r24.proceed(r25)
        L_0x000d:
            throwExceptionIfInterruptedOrCancelled(r27)     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            ...
            android.net.Uri r5 = r3.uri     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            int r6 = r3.httpMethod     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            byte[] r7 = r3.httpBody     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            long r8 = r3.position     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            long r8 = r8 + r18
            long r10 = r3.absoluteStreamPosition     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            long r10 = r8 - r10
            r12 = -1
            java.lang.String r14 = r3.key     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            int r4 = r3.flags     // Catch:{ PriorityTooLowException -> 0x0088, all -> 0x0083 }
            r16 = r4 | 2
            r4 = r15
            r8 = r18
            r17 = r3
            ...
            long r4 = r1.open(r3)     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            long r6 = r2.contentLength     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            r8 = -1
            int r10 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r10 != 0) goto L_0x0048
            int r6 = (r4 > r8 ? 1 : (r4 == r8 ? 0 : -1))
            if (r6 == 0) goto L_0x0048
            long r6 = r3.absoluteStreamPosition     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            long r6 = r6 + r4
            r2.contentLength = r6     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
        L_0x0048:
            r4 = 0
        L_0x004a:
            int r6 = (r4 > r20 ? 1 : (r4 == r20 ? 0 : -1))
            if (r6 == 0) goto L_0x007c
            throwExceptionIfInterruptedOrCancelled(r27)     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            r6 = 0
        ...
        L_0x0074:
            ...
            long r4 = r4 + r6
            long r10 = r2.newlyCachedBytes     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            long r10 = r10 + r6
            r2.newlyCachedBytes = r10     // Catch:{ PriorityTooLowException -> 0x008a, all -> 0x0083 }
            goto L_0x004a
        L_0x007c:
