...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzb)).add("resolution", this.zzc).add(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, this.zzd).toString();
    }
