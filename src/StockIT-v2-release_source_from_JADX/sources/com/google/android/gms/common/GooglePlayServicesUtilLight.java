...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C1526R.string.common_google_play_services_unknown_issue);
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zze.get()) {
            ...
            if (zzb2 == 0) {
                ...
                StringBuilder sb = new StringBuilder(VoiceActivityDetector.FRAME_SIZE_IN_BYTES);
