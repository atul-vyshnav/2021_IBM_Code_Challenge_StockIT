...
class zzl {
    ...
    static String zza(String str, zzd zzd2, boolean z, boolean z2) {
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", new Object[]{z2 ? "debug cert rejected" : "not whitelisted", str, Hex.bytesToStringLowercase(AndroidUtilsLight.zza(MessageDigestAlgorithms.SHA_1).digest(zzd2.zza())), Boolean.valueOf(z), "12451009.false"});
    }
}
