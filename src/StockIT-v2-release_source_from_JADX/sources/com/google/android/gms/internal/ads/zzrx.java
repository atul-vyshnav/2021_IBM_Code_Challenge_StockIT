...
public final class zzrx extends zzrq {
    ...
    public final byte[] zzbu(java.lang.String r10) {
        /*
            ...
            monitor-enter(r0)
            java.security.MessageDigest r1 = r9.zzms()     // Catch:{ all -> 0x0067 }
            r9.zzbug = r1     // Catch:{ all -> 0x0067 }
            r2 = 0
        ...
        L_0x0010:
            ...
            java.security.MessageDigest r1 = r9.zzbug     // Catch:{ all -> 0x0067 }
            ...
            java.security.MessageDigest r10 = r9.zzbug     // Catch:{ all -> 0x0067 }
            byte[] r10 = r10.digest()     // Catch:{ all -> 0x0067 }
            int r1 = r10.length     // Catch:{ all -> 0x0067 }
            int r3 = r9.zzbuh     // Catch:{ all -> 0x0067 }
            if (r1 <= r3) goto L_0x0030
            int r1 = r9.zzbuh     // Catch:{ all -> 0x0067 }
            goto L_0x0031
        L_0x0030:
            int r1 = r10.length     // Catch:{ all -> 0x0067 }
        L_0x0031:
            ...
            int r10 = r9.zzbui     // Catch:{ all -> 0x0067 }
            r4 = 8
            int r10 = r10 % r4
        ...
        L_0x004d:
            ...
            int r10 = 8 - r10
            long r1 = r5 >>> r10
            int r10 = r9.zzbuh     // Catch:{ all -> 0x0067 }
            int r10 = r10 + -1
        L_0x0058:
            if (r10 < 0) goto L_0x0065
