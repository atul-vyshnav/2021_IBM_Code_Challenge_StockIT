...
final class zzvw extends zzwn<zzxc> {
    ...
    zzvw(zzvx zzvx, Context context, zzvn zzvn, String str, zzanb zzanb) {
        this.zzcij = zzvx;
    ...
    public final /* synthetic */ Object zzpq() throws RemoteException {
        return this.zzcij.zzcik.zza(this.val$context, this.zzcig, this.zzcih, this.zzcii, 1);
    }

    public final /* synthetic */ Object zza(zzxp zzxp) throws RemoteException {
        return zzxp.zza(ObjectWrapper.wrap(this.val$context), this.zzcig, this.zzcih, this.zzcii, 202510000);
    }
}
