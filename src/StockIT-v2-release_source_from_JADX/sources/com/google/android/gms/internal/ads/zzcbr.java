...
public final class zzcbr implements zzeoy<zzawp> {
    ...
    private zzcbr(zzcbf zzcbf, zzeph<Context> zzeph, zzeph<zzdok> zzeph2) {
        this.zzfwx = zzcbf;
        this.zzesu = zzeph;
        this.zzfqr = zzeph2;
    }

    public static zzcbr zza(zzcbf zzcbf, zzeph<Context> zzeph, zzeph<zzdok> zzeph2) {
        return new zzcbr(zzcbf, zzeph, zzeph2);
    }
