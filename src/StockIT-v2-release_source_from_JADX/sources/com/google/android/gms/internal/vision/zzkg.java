...
interface zzkg {
    ...
    void zza(int i, zzfh zzfh) throws IOException;

    <K, V> void zza(int i, zzht<K, V> zzht, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzir zzir) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzir zzir) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzir zzir) throws IOException;

    void zzb(int i, List<zzfh> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzir zzir) throws IOException;

    void zzb(int i, List<Integer> list, boolean z) throws IOException;

    @Deprecated
    void zzbj(int i) throws IOException;
