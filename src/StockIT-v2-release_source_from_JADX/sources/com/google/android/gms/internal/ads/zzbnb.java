...
public final class zzbnb implements zzeoy<Set<zzcab<zzqu>>> {
    ...
    private zzbnb(zzeph<zzbmu> zzeph, zzeph<Executor> zzeph2, zzeph<JSONObject> zzeph3) {
        this.zzfop = zzeph;
        this.zzesr = zzeph2;
        this.zzfoq = zzeph3;
    }

    public static zzbnb zzc(zzeph<zzbmu> zzeph, zzeph<Executor> zzeph2, zzeph<JSONObject> zzeph3) {
        return new zzbnb(zzeph, zzeph2, zzeph3);
    }
