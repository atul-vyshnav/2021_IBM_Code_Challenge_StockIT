...
final class zzenm extends zzenh {
    zzenm() {
    }

    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0035, code lost:
        if (com.google.android.gms.internal.ads.zzend.zza(r1, r8) > -65) goto L_0x003c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0066, code lost:
        if (com.google.android.gms.internal.ads.zzend.zza(r1, r8) > -65) goto L_0x0068;
     */
    ...
    public final int zzb(int r22, byte[] r23, int r24, int r25) {
        ...
        L_0x002a:
            ...
            long r19 = r8 + r16
            byte r0 = com.google.android.gms.internal.ads.zzend.zza(r1, r8)
        ...
        L_0x003d:
            ...
            int r0 = com.google.android.gms.internal.ads.zzeng.zzap(r5, r0)
            return r0
        L_0x0054:
            r8 = r19
        L_0x0056:
        ...
        L_0x0069:
            ...
            long r19 = r8 + r16
            byte r4 = com.google.android.gms.internal.ads.zzend.zza(r1, r8)
            int r0 = (r19 > r2 ? 1 : (r19 == r2 ? 0 : -1))
            if (r0 < 0) goto L_0x007e
            int r0 = com.google.android.gms.internal.ads.zzeng.zzap(r5, r4)
            return r0
        L_0x007e:
            r8 = r19
            r0 = 0
        ...
        L_0x0084:
            ...
            int r0 = com.google.android.gms.internal.ads.zzeng.zzj(r5, r4, r0)
            return r0
        L_0x0095:
            r8 = r19
        L_0x0097:
        ...
        L_0x00b8:
            ...
            long r19 = r3 + r16
            byte r3 = com.google.android.gms.internal.ads.zzend.zza(r1, r3)
        ...
        L_0x0104:
            int r0 = r0 + -2
            long r3 = r8 + r16
            byte r5 = com.google.android.gms.internal.ads.zzend.zza(r1, r8)
        ...
        L_0x0118:
            long r8 = r3 + r16
            byte r2 = com.google.android.gms.internal.ads.zzend.zza(r1, r3)
        ...
        L_0x0153:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzenm.zzb(int, byte[], int, int):int");
    }

    /* access modifiers changed from: package-private */
    public final String zzo(byte[] bArr, int i, int i2) throws zzekj {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            int i3 = i + i2;
            char[] cArr = new char[i2];
            int i4 = 0;
            while (r13 < i3) {
                byte zza = zzend.zza(bArr, (long) r13);
                if (!zzeni.zze(zza)) {
                    break;
                }
                i = r13 + 1;
                zzeni.zza(zza, cArr, i4);
                i4++;
            }
            int i5 = i4;
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte zza2 = zzend.zza(bArr, (long) r13);
                if (zzeni.zze(zza2)) {
                    int i7 = i5 + 1;
                    zzeni.zza(zza2, cArr, i5);
                    while (i6 < i3) {
                        byte zza3 = zzend.zza(bArr, (long) i6);
                        if (!zzeni.zze(zza3)) {
                            break;
                        }
                        i6++;
                        zzeni.zza(zza3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (zzeni.zzf(zza2)) {
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        zzeni.zza(zza2, zzend.zza(bArr, (long) i6), cArr, i5);
                        r13 = i8;
                        i5++;
                    } else {
                        throw zzekj.zzbhf();
                    }
                } else if (zzeni.zzg(zza2)) {
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzeni.zza(zza2, zzend.zza(bArr, (long) i6), zzend.zza(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw zzekj.zzbhf();
                    ...
                    int i11 = i6 + 1;
                    byte zza4 = zzend.zza(bArr, (long) i6);
                    int i12 = i11 + 1;
                    zzeni.zza(zza2, zza4, zzend.zza(bArr, (long) i11), zzend.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzekj.zzbhf();
    ...
    public final int zzb(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x001a:
            ...
            long r11 = r11 + r4
            byte r3 = (byte) r13
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r4, (byte) r3)
            int r2 = r2 + 1
            r4 = r11
            goto L_0x001a
        L_0x002f:
        ...
        L_0x0033:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r4, (byte) r13)
            r4 = r11
            r12 = r14
        L_0x0047:
        ...
        L_0x004b:
            ...
            r5 = r5 | r13
            byte r5 = (byte) r5
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r14, (byte) r5)
            r20 = r11
            r11 = 128(0x80, float:1.794E-43)
            r12 = r3
            r4 = r20
        ...
        L_0x007f:
            ...
            r5 = r5 | r11
            byte r5 = (byte) r5
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r3, (byte) r5)
            r12 = r18
            r4 = 1
            goto L_0x0047
        L_0x00ae:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r4, (byte) r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.ads.zzend.zza((byte[]) r1, (long) r14, (byte) r2)
            r2 = r3
        L_0x00fb:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0146:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzenm.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return zzeng.zzap(i, zzend.zza(bArr, j));
        }
        if (i2 == 2) {
            return zzeng.zzj(i, zzend.zza(bArr, j), zzend.zza(bArr, j + 1));
        }
