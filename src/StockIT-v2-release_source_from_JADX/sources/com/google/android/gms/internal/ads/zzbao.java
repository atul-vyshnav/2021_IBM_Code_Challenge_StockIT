...
public final class zzbao {
    private static final zzbaq<Map<String, ?>> zzecz = new zzbar();
    ...
    public static String zza(zzbat zzbat) {
        return zzk(zzbat);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzayp.zzc("Error when writing JSON.", e);
            return null;
        }
    }
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzayp.zzfe(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            ...
                            zzayp.zzfe(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                    ...
                    zzayp.zzfe(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
