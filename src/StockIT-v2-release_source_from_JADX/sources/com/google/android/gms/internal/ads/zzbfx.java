...
public final class zzbfx extends zzbfl implements zzpa<zzom> {
    ...
    private final zzbfu zzemg = new zzbfu();
    private final zzbfd zzemh = new zzbfd();
    private boolean zzemi;
    private final Object zzemj = new Object();
    private boolean zzemk;

    public zzbfx(zzbdu zzbdu, zzbdv zzbdv) {
        super(zzbdu);
        this.zzejr = zzbdv;
    }
    ...
    private final void zzzk() {
        ...
        int round = Math.round(((float) zzq) * (((float) position) / ((float) zzaay)));
        boolean z = round > 0;
        int zzaav = zzber.zzaav();
        int zzaaw = zzber.zzaaw();
        String str = this.url;
        zza(str, zzfo(str), position, zzaay, (long) round, (long) zzq, z, zzaav, zzaaw);
    }

    /* JADX WARNING: type inference failed for: r1v31, types: [com.google.android.gms.internal.ads.zzbem] */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00c2, code lost:
        if (r9.zzamm.remaining() > 0) goto L_0x00c9;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x00cb, code lost:
        if (r9.zzema != false) goto L_0x010b;
     */
    ...
    public final boolean zzfn(java.lang.String r22) {
        /*
            ...
            r13 = 0
            com.google.android.gms.internal.ads.zzop r0 = new com.google.android.gms.internal.ads.zzop     // Catch:{ Exception -> 0x013c }
            java.lang.String r2 = r9.zzedk     // Catch:{ Exception -> 0x013c }
            r3 = 0
            com.google.android.gms.internal.ads.zzbdv r1 = r9.zzejr     // Catch:{ Exception -> 0x013c }
            int r5 = r1.zzeis     // Catch:{ Exception -> 0x013c }
            com.google.android.gms.internal.ads.zzbdv r1 = r9.zzejr     // Catch:{ Exception -> 0x013c }
            int r6 = r1.zzeiu     // Catch:{ Exception -> 0x013c }
            r7 = 1
            r8 = 0
            r1 = r0
            r4 = r21
            ...
            com.google.android.gms.internal.ads.zzbdv r1 = r9.zzejr     // Catch:{ Exception -> 0x013c }
            boolean r1 = r1.zzeiy     // Catch:{ Exception -> 0x013c }
            if (r1 == 0) goto L_0x0035
            com.google.android.gms.internal.ads.zzbem r1 = new com.google.android.gms.internal.ads.zzbem     // Catch:{ Exception -> 0x0032 }
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzon r2 = new com.google.android.gms.internal.ads.zzon     // Catch:{ Exception -> 0x013c }
            r2.<init>(r1)     // Catch:{ Exception -> 0x013c }
            r0.zza(r2)     // Catch:{ Exception -> 0x013c }
            java.lang.ref.WeakReference r1 = r9.zzels     // Catch:{ Exception -> 0x013c }
            java.lang.Object r1 = r1.get()     // Catch:{ Exception -> 0x013c }
            com.google.android.gms.internal.ads.zzbdu r1 = (com.google.android.gms.internal.ads.zzbdu) r1     // Catch:{ Exception -> 0x013c }
            if (r1 == 0) goto L_0x004e
            r1.zza((java.lang.String) r11, (com.google.android.gms.internal.ads.zzbfl) r9)     // Catch:{ Exception -> 0x0032 }
        L_0x004e:
            com.google.android.gms.common.util.Clock r1 = com.google.android.gms.ads.internal.zzp.zzky()     // Catch:{ Exception -> 0x013c }
            long r2 = r1.currentTimeMillis()     // Catch:{ Exception -> 0x013c }
            com.google.android.gms.internal.ads.zzaaq<java.lang.Long> r4 = com.google.android.gms.internal.ads.zzabb.zzcmk     // Catch:{ Exception -> 0x013c }
            com.google.android.gms.internal.ads.zzaax r5 = com.google.android.gms.internal.ads.zzwm.zzpx()     // Catch:{ Exception -> 0x013c }
            ...
            com.google.android.gms.internal.ads.zzaaq<java.lang.Long> r6 = com.google.android.gms.internal.ads.zzabb.zzcmj     // Catch:{ Exception -> 0x013c }
            com.google.android.gms.internal.ads.zzaax r7 = com.google.android.gms.internal.ads.zzwm.zzpx()     // Catch:{ Exception -> 0x013c }
            ...
            com.google.android.gms.internal.ads.zzbdv r8 = r9.zzejr     // Catch:{ Exception -> 0x013c }
            int r8 = r8.zzeir     // Catch:{ Exception -> 0x013c }
            java.nio.ByteBuffer r8 = java.nio.ByteBuffer.allocate(r8)     // Catch:{ Exception -> 0x013c }
            r9.zzamm = r8     // Catch:{ Exception -> 0x013c }
            r8 = 8192(0x2000, float:1.14794E-41)
            byte[] r15 = new byte[r8]     // Catch:{ Exception -> 0x013c }
            r16 = r2
        L_0x0086:
            java.nio.ByteBuffer r14 = r9.zzamm     // Catch:{ Exception -> 0x013c }
            ...
            r8 = 1
            r9.zzemk = r8     // Catch:{ Exception -> 0x0032 }
            com.google.android.gms.internal.ads.zzbfd r0 = r9.zzemh     // Catch:{ Exception -> 0x0032 }
            java.nio.ByteBuffer r1 = r9.zzamm     // Catch:{ Exception -> 0x0032 }
            long r0 = r0.zzq(r1)     // Catch:{ Exception -> 0x0032 }
        ...
        L_0x00a7:
            ...
            goto L_0x00c8
        L_0x00a9:
            java.lang.Object r8 = r9.zzemj     // Catch:{ Exception -> 0x013c }
            monitor-enter(r8)     // Catch:{ Exception -> 0x013c }
            boolean r13 = r9.zzema     // Catch:{ all -> 0x0131 }
            if (r13 != 0) goto L_0x00b9
            java.nio.ByteBuffer r13 = r9.zzamm     // Catch:{ all -> 0x0131 }
            r18 = r12
            r12 = 0
        ...
        L_0x00bb:
            ...
            java.nio.ByteBuffer r8 = r9.zzamm     // Catch:{ Exception -> 0x0136 }
            int r8 = r8.remaining()     // Catch:{ Exception -> 0x0136 }
            if (r8 > 0) goto L_0x00c9
            r21.zzzk()     // Catch:{ Exception -> 0x0136 }
            goto L_0x00a7
        L_0x00c8:
            return r1
        L_0x00c9:
            boolean r8 = r9.zzema     // Catch:{ Exception -> 0x0136 }
        ...
        L_0x013f:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbfx.zzfn(java.lang.String):boolean");
    }
