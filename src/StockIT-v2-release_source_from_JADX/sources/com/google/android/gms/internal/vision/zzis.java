...
interface zzis {
    ...
    <T> T zza(zzir<T> zzir, zzgd zzgd) throws IOException;

    <T> T zza(Class<T> cls, zzgd zzgd) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzir<T> zzir, zzgd zzgd) throws IOException;

    <K, V> void zza(Map<K, V> map, zzht<K, V> zzht, zzgd zzgd) throws IOException;
