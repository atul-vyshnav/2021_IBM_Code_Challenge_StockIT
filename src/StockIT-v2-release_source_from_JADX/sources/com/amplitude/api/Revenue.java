...
public class Revenue {
    ...
    public boolean isValidRevenue() {
        ...
        logger.mo10617w(TAG, "Invalid revenue, need to set price");
        return false;
    }

    public Revenue setProductId(String str) {
        if (C0772Utils.isEmptyString(str)) {
            logger.mo10617w(TAG, "Invalid empty productId");
            return this;
        }
        this.productId = str;
        return this;
    ...
    public Revenue setRevenueProperties(JSONObject jSONObject) {
        logger.mo10617w(TAG, "setRevenueProperties is deprecated, please use setEventProperties instead");
        return setEventProperties(jSONObject);
    }

    public Revenue setEventProperties(JSONObject jSONObject) {
        this.properties = C0772Utils.cloneJSONObject(jSONObject);
        return this;
    }
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            logger.mo10606e(TAG, String.format("Failed to convert revenue object to JSON: %s", new Object[]{e.toString()}));
        }
        return jSONObject;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (jSONObject != null) {
            if (!C0772Utils.compareJSONObjects(jSONObject, jSONObject2)) {
                return false;
            }
            return true;
