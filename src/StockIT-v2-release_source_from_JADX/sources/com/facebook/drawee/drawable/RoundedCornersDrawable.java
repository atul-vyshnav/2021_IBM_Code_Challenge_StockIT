...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
    ...
    static /* synthetic */ class C08951 {
        ...
        static final /* synthetic */ int[] f87xda0cffae;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f87xda0cffae     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.drawable.RoundedCornersDrawable.C08951.<clinit>():void");
        }
    }

    public void draw(Canvas canvas) {
        this.mBounds.set(getBounds());
        int i = C08951.f87xda0cffae[this.mType.ordinal()];
        if (i == 1) {
