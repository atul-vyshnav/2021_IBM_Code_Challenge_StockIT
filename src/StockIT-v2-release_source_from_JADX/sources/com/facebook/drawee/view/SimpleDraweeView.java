...
import com.facebook.drawee.C0882R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (attributeSet != null) {
                obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0882R.styleable.SimpleDraweeView);
                if (obtainStyledAttributes.hasValue(C0882R.styleable.SimpleDraweeView_actualImageUri)) {
                    setImageURI(Uri.parse(obtainStyledAttributes.getString(C0882R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                } else if (obtainStyledAttributes.hasValue(C0882R.styleable.SimpleDraweeView_actualImageResource) && (resourceId = obtainStyledAttributes.getResourceId(C0882R.styleable.SimpleDraweeView_actualImageResource, -1)) != -1) {
                    if (isInEditMode()) {
