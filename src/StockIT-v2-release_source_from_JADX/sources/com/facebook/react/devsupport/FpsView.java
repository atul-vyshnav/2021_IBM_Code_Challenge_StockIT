...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C1045R.C1048id.fps_text));

    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C1045R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m52d(ReactConstants.TAG, format);
    }
