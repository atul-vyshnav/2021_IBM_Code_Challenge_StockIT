...
public enum TextTransform {
    ...
    static /* synthetic */ class C13221 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.text.TextTransform.C13221.<clinit>():void");
        }
    }
    ...
    public static String apply(String str, TextTransform textTransform) {
        ...
        int i = C13221.$SwitchMap$com$facebook$react$views$text$TextTransform[textTransform.ordinal()];
        if (i == 1) {
