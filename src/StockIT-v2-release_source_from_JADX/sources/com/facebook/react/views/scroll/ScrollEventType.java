    ...
    static /* synthetic */ class C13151 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.scroll.ScrollEventType.C13151.<clinit>():void");
        }
    }

    public static String getJSEventName(ScrollEventType scrollEventType) {
        int i = C13151.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType[scrollEventType.ordinal()];
        if (i == 1) {
