...
public class Arguments {
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C10922.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C10922 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.Arguments.C10922.<clinit>():void");
        }
    }
    ...
    public static Bundle toBundle(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (C10922.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                case 1:
