...
public class ReactContext extends ContextWrapper {
    ...
    public void addLifecycleEventListener(final LifecycleEventListener lifecycleEventListener) {
        ...
        if (hasActiveCatalystInstance() && (i = C11232.$SwitchMap$com$facebook$react$common$LifecycleState[this.mLifecycleState.ordinal()]) != 1 && i != 2) {
            if (i == 3) {
    ...
    static /* synthetic */ class C11232 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.ReactContext.C11232.<clinit>():void");
        }
    }
    ...
    public void handleException(Exception exc) {
        ...
        if (!z3 || !z) {
            ...
            sb.append(z);
            FLog.m65e(ReactConstants.TAG, sb.toString(), (Throwable) exc);
