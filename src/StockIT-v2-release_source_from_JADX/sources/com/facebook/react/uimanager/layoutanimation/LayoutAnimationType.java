...
enum LayoutAnimationType {
    ...
    static /* synthetic */ class C13021 {
        ...
        static final /* synthetic */ int[] f111x364296ff = null;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f111x364296ff     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f111x364296ff     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.layoutanimation.LayoutAnimationType.C13021.<clinit>():void");
        }
    }

    public static String toString(LayoutAnimationType layoutAnimationType) {
        int i = C13021.f111x364296ff[layoutAnimationType.ordinal()];
        if (i == 1) {
            return "create";
        }
        if (i == 2) {
