...
abstract class BaseLayoutAnimation extends AbstractLayoutAnimation {
    ...
    static /* synthetic */ class C12981 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f110x36728427     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f110x36728427     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f110x36728427     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C12981.<clinit>():void");
        }
    }
    ...
    public Animation createAnimationImpl(View view, int i, int i2, int i3, int i4) {
        if (this.mAnimatedProperty != null) {
            int i5 = C12981.f110x36728427[this.mAnimatedProperty.ordinal()];
            float f = 0.0f;
            if (i5 == 1) {
