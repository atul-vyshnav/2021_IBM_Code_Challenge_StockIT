    ...
    static /* synthetic */ class C12971 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.events.TouchEventType.C12971.<clinit>():void");
        }
    }

    public static String getJSEventName(TouchEventType touchEventType) {
        int i = C12971.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[touchEventType.ordinal()];
        if (i == 1) {
