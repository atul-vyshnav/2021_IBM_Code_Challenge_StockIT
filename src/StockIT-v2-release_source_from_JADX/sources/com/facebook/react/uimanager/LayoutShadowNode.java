...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private final MutableYogaValue mTempYogaValue = new MutableYogaValue((C12771) null);

    private static class MutableYogaValue {
        YogaUnit unit;
        float value;

        /* synthetic */ MutableYogaValue(C12771 r1) {
            this();
        }
    ...
    public void setWidth(Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            int i = C12771.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C12771 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.LayoutShadowNode.C12771.<clinit>():void");
        }
    }
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C12771.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 == 1 || i2 == 2) {
