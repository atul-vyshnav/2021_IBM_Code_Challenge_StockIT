...
public class UIManagerModule extends ReactContextBaseJavaModule implements OnBatchCompleteListener, LifecycleEventListener, UIManager {
    ...
    public void createView(int i, String str, int i2, ReadableMap readableMap) {
        if (DEBUG) {
            ...
            FLog.m52d(ReactConstants.TAG, str2);
    ...
    public void updateView(final int r4, java.lang.String r5, final com.facebook.react.bridge.ReadableMap r6) {
        /*
            ...
            com.facebook.common.logging.FLog.m52d((java.lang.String) r1, (java.lang.String) r0)
    ...
    public void manageChildren(int i, ReadableArray readableArray, ReadableArray readableArray2, ReadableArray readableArray3, ReadableArray readableArray4, ReadableArray readableArray5) {
        if (DEBUG) {
            ...
            FLog.m52d(ReactConstants.TAG, str);
    ...
    public void invalidateNodeLayout(int i) {
        ...
        if (resolveShadowNode == null) {
            FLog.m104w(ReactConstants.TAG, "Warning : attempted to dirty a non-existent react shadow node. reactTag=" + i);
            return;
        }
