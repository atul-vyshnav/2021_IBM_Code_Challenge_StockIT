...
public abstract class PlatformBitmapFactory {
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C09421.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C09421 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C09421.<clinit>():void");
        }
    }
