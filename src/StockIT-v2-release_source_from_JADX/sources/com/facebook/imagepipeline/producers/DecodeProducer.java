...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        /* access modifiers changed from: private */
        /* JADX WARNING: Removed duplicated region for block: B:31:0x00b5 A[Catch:{ all -> 0x016b }] */
        /* JADX WARNING: Removed duplicated region for block: B:42:0x00db  */
        /* JADX WARNING: Removed duplicated region for block: B:47:0x00ef A[Catch:{ all -> 0x016b }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r19, int r20) {
            ...
            L_0x0090:
                r14 = r2
                com.facebook.imagepipeline.producers.JobScheduler r2 = r11.mJobScheduler     // Catch:{ all -> 0x016b }
                long r15 = r2.getQueuedTime()     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.request.ImageRequest r2 = r2.getImageRequest()     // Catch:{ all -> 0x016b }
                android.net.Uri r2 = r2.getSourceUri()     // Catch:{ all -> 0x016b }
                java.lang.String r2 = java.lang.String.valueOf(r2)     // Catch:{ all -> 0x016b }
                if (r5 != 0) goto L_0x00af
                if (r13 == 0) goto L_0x00aa
                goto L_0x00af
            L_0x00aa:
                int r3 = r18.getIntermediateImageEndOffset(r19)     // Catch:{ all -> 0x016b }
                goto L_0x00b3
            L_0x00af:
                int r3 = r19.getSize()     // Catch:{ all -> 0x016b }
            L_0x00b3:
                if (r5 != 0) goto L_0x00bd
                if (r13 == 0) goto L_0x00b8
                goto L_0x00bd
            L_0x00b8:
                com.facebook.imagepipeline.image.QualityInfo r5 = r18.getQualityInfo()     // Catch:{ all -> 0x016b }
                goto L_0x00bf
            L_0x00bd:
                com.facebook.imagepipeline.image.QualityInfo r5 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x016b }
            L_0x00bf:
                com.facebook.imagepipeline.producers.ProducerListener2 r13 = r11.mProducerListener     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r1 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                r13.onProducerStart(r1, r12)     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.DecodeProducer r13 = com.facebook.imagepipeline.producers.DecodeProducer.this     // Catch:{ DecodeException -> 0x0127 }
                com.facebook.imagepipeline.decoder.ImageDecoder r13 = r13.mImageDecoder     // Catch:{ DecodeException -> 0x0127 }
                com.facebook.imagepipeline.common.ImageDecodeOptions r1 = r11.mImageDecodeOptions     // Catch:{ DecodeException -> 0x0127 }
                r4 = r19
                com.facebook.imagepipeline.image.CloseableImage r13 = r13.decode(r4, r3, r5, r1)     // Catch:{ DecodeException -> 0x0127 }
                int r1 = r19.getSampleSize()     // Catch:{ Exception -> 0x0121 }
                r2 = 1
            ...
            L_0x00dd:
                ...
                r3 = r15
                r9 = r14
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                r2.onProducerFinishWithSuccess(r3, r12, r1)     // Catch:{ all -> 0x016b }
                if (r13 == 0) goto L_0x011a
                com.facebook.imagepipeline.image.OriginalEncodedImageInfo r1 = new com.facebook.imagepipeline.image.OriginalEncodedImageInfo     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.request.ImageRequest r2 = r2.getImageRequest()     // Catch:{ all -> 0x016b }
                android.net.Uri r5 = r2.getSourceUri()     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.image.EncodedImageOrigin r6 = r2.getEncodedImageOrigin()     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                java.lang.Object r7 = r2.getCallerContext()     // Catch:{ all -> 0x016b }
                int r8 = r19.getWidth()     // Catch:{ all -> 0x016b }
                int r9 = r19.getHeight()     // Catch:{ all -> 0x016b }
                int r10 = r19.getSize()     // Catch:{ all -> 0x016b }
                r4 = r1
                r4.<init>(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x016b }
                r13.setOriginalEncodedImageInfo(r1)     // Catch:{ all -> 0x016b }
            L_0x011a:
                r11.handleResult(r13, r0)     // Catch:{ all -> 0x016b }
            ...
            L_0x0127:
                r0 = move-exception
                com.facebook.imagepipeline.image.EncodedImage r1 = r0.getEncodedImage()     // Catch:{ Exception -> 0x0124 }
                java.lang.String r3 = "ProgressiveDecoder"
                java.lang.String r4 = "%s, {uri: %s, firstEncodedBytes: %s, length: %d}"
                java.lang.Object[] r9 = new java.lang.Object[r9]     // Catch:{ Exception -> 0x0124 }
                java.lang.String r13 = r0.getMessage()     // Catch:{ Exception -> 0x0124 }
                r17 = 0
                r9[r17] = r13     // Catch:{ Exception -> 0x0124 }
                r13 = 1
                r9[r13] = r2     // Catch:{ Exception -> 0x0124 }
                r2 = 2
                r13 = 10
                java.lang.String r13 = r1.getFirstBytesAsHexString(r13)     // Catch:{ Exception -> 0x0124 }
                r9[r2] = r13     // Catch:{ Exception -> 0x0124 }
                r2 = 3
                int r1 = r1.getSize()     // Catch:{ Exception -> 0x0124 }
                java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ Exception -> 0x0124 }
                r9[r2] = r1     // Catch:{ Exception -> 0x0124 }
                com.facebook.common.logging.FLog.m106w((java.lang.String) r3, (java.lang.String) r4, (java.lang.Object[]) r9)     // Catch:{ Exception -> 0x0124 }
            ...
            L_0x0155:
                ...
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x016b }
                r2.onProducerFinishWithFailure(r3, r12, r0, r1)     // Catch:{ all -> 0x016b }
                r11.handleError(r0)     // Catch:{ all -> 0x016b }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r19)
                return
            L_0x016b:
                r0 = move-exception
    ...
    private class LocalImagesProgressiveDecoder extends ProgressiveDecoder {
        ...
        public QualityInfo getQualityInfo() {
            return ImmutableQualityInfo.m136of(0, false, false);
        }
    }
