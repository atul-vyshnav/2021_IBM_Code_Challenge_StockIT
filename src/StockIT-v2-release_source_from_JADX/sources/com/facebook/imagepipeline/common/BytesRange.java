...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format((Locale) null, "bytes=%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f90to)});
    }

    public boolean contains(@Nullable BytesRange bytesRange) {
        return bytesRange != null && this.from <= bytesRange.from && this.f90to >= bytesRange.f90to;
    }

    public String toString() {
        return String.format((Locale) null, "%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f90to)});
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.from == bytesRange.from && this.f90to == bytesRange.f90to) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f90to);
    }
