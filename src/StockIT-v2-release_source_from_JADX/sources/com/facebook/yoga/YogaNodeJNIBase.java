...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    static /* synthetic */ class C13371 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaNodeJNIBase.C13371.<clinit>():void");
        }
    }
    ...
    public float getLayoutMargin(YogaEdge yogaEdge) {
        ...
        switch (C13371.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
                return this.arr[6];
            case 2:
                return this.arr[7];
