...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        byte read2 = ((byte) inputStream.read()) & UByte.MAX_VALUE;
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 24) & UByte.MIN_VALUE) | ((((byte) inputStream.read()) << 16) & UByte.MIN_VALUE) | ((((byte) inputStream.read()) << 8) & UByte.MIN_VALUE) | (((byte) inputStream.read()) & UByte.MAX_VALUE);
    }

    public static int get2BytesAsInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 8) & UByte.MIN_VALUE) | (((byte) inputStream.read()) & UByte.MAX_VALUE);
    }

    private static int read3Bytes(InputStream inputStream) throws IOException {
        byte b = getByte(inputStream);
        return ((getByte(inputStream) << 16) & UByte.MIN_VALUE) | ((getByte(inputStream) << 8) & UByte.MIN_VALUE) | (b & UByte.MAX_VALUE);
    }
