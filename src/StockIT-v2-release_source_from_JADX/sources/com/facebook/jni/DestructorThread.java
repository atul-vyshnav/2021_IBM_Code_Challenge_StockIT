...
public class DestructorThread {
    ...
    static {
        C10341 r0 = new Thread("HybridData DestructorThread") {
            ...
            public void run() {
                ...
                L_0x001a:
                    ...
                    goto L_0x0000
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.jni.DestructorThread.C10341.run():void");
            }
        };
        sThread = r0;
        r0.start();
