    ...
    public static String[] extract_DT_NEEDED(FileChannel fileChannel) throws IOException {
        ...
        if (getu32(fileChannel2, allocate, 0) == 1179403647) {
            ...
            while (true) {
                ...
                if (z) {
                    j10 = getu32(fileChannel2, allocate, j13 + 0);
                } else {
                    j10 = getu32(fileChannel2, allocate, j13 + 0);
                }
                if (j10 != 2) {
            ...
            if (j != 0) {
                ...
                while (true) {
                    ...
                    if (r7 == 1) {
                        ...
                        if (r7 == 5) {
                            if (z2) {
                                j9 = getu32(fileChannel2, allocate, j16 + 4);
                            } else {
                                j9 = get64(fileChannel2, allocate, j16 + 8);
                            }
                            j17 = j9;
                        }
                    }
                    ...
                    if (r7 != 0) {
                        ...
                        while (true) {
                            ...
                            if (j4 == 1) {
                                if (z2) {
                                    ...
                                    j6 = get64(fileChannel2, allocate, r15 + j18);
                                }
                                if (z2) {
                                    j5 = j12;
                        ...
                        if (j3 != 0) {
                            ...
                            while (true) {
                                long j20 = j2 + j19;
                                long r10 = z2 ? getu32(fileChannel2, allocate, j20) : get64(fileChannel2, allocate, j20);
                                if (r10 == 1) {
