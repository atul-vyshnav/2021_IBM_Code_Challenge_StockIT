...
public class RNUtils {
    ...
    public static JSONObject readableMapToJson(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            try {
                switch (C13531.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C13531 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.geektime.rnonesignalandroid.RNUtils.C13531.<clinit>():void");
        }
    }
