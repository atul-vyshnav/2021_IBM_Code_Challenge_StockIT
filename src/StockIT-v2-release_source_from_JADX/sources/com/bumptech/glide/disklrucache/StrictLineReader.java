...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f56CR = 13;

    /* renamed from: LF */
    private static final byte f57LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f58in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f58in) {
            if (this.buf != null) {
                ...
                C07891 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f58in;
        byte[] bArr = this.buf;
