...
class DataCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final DataFetcherGenerator.FetcherReadyCallback f64cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f64cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f64cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(Exception exc) {
        this.f64cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
