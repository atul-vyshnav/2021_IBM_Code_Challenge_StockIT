...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0051, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r4, r1.f68cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004b:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f68cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004b
        L_0x0064:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x002f, code lost:
        r4.listener.onEngineJobComplete(r4, r1, (com.bumptech.glide.load.engine.EngineResource<?>) null);
        r0 = r2.iterator();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f68cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f66cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f66cb = resourceCallback;
        }

        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f66cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f66cb);
                }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f67cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f67cb = resourceCallback;
        }

        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f67cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f67cb);
                    EngineJob.this.removeCallback(this.f67cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f68cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f68cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f68cb.equals(((ResourceCallbackAndExecutor) obj).f68cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f68cb.hashCode();
        }
    }
