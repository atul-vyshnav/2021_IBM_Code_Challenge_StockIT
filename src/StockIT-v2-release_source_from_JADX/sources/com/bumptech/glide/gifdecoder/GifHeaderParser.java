...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f61ix = readShort();
        this.header.currentFrame.f62iy = readShort();
        this.header.currentFrame.f60iw = readShort();
        this.header.currentFrame.f59ih = readShort();
        int read = read();
        boolean z = false;
