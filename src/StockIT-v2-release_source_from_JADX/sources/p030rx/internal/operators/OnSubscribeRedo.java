...
public final class OnSubscribeRedo<T> implements Observable.OnSubscribe<T> {
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        C36742 r1 = new Action0() {
            public void call() {
                if (!subscriber2.isUnsubscribed()) {
                    C36751 r0 = new Subscriber<T>() {
                        boolean done;
                        ...
                        private void decrementConsumerCapacity() {
                            /*
                                r5 = this;
                            L_0x0000:
                                rx.internal.operators.OnSubscribeRedo$2 r0 = p030rx.internal.operators.OnSubscribeRedo.C36742.this
                                java.util.concurrent.atomic.AtomicLong r0 = r6
                                long r0 = r0.get()
                                r2 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
                                int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
                                if (r4 == 0) goto L_0x001f
                                rx.internal.operators.OnSubscribeRedo$2 r2 = p030rx.internal.operators.OnSubscribeRedo.C36742.this
                            ...
                            L_0x001f:
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.operators.OnSubscribeRedo.C36742.C36751.decrementConsumerCapacity():void");
                        }
