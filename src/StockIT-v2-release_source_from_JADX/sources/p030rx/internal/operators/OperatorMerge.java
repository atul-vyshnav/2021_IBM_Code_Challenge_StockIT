...
import p030rx.internal.util.atomic.SpscAtomicArrayQueue;
import p030rx.internal.util.atomic.SpscExactAtomicArrayQueue;
import p030rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p030rx.internal.util.unsafe.Pow2;
import p030rx.internal.util.unsafe.SpscArrayQueue;
import p030rx.internal.util.unsafe.UnsafeAccess;
...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
            ...
            */
        protected void emitScalar(p030rx.internal.operators.OperatorMerge.InnerSubscriber<T> r5, T r6, long r7) {
            /*
                r4 = this;
                r0 = 1
                r1 = 0
            ...
            L_0x0008:
                ...
                p030rx.exceptions.Exceptions.throwIfFatal(r6)     // Catch:{ all -> 0x0046 }
            ...
            L_0x0052:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(rx.internal.operators.OperatorMerge$InnerSubscriber, java.lang.Object, long):void");
        }
        ...
        protected void emitScalar(T r5, long r6) {
            ...
            L_0x0008:
                ...
                if (r2 != 0) goto L_0x0019
                p030rx.exceptions.Exceptions.throwIfFatal(r5)     // Catch:{ all -> 0x0051 }
            ...
            L_0x005d:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(java.lang.Object, long):void");
        }
        ...
        public void emitLoop() {
            ...
            L_0x003b:
                ...
                goto L_0x0071
            L_0x0040:
                java.lang.Object r0 = p030rx.internal.operators.NotificationLite.getValue(r18)     // Catch:{ all -> 0x0197 }
            ...
            L_0x0048:
                ...
                p030rx.exceptions.Exceptions.throwIfFatal(r19)     // Catch:{ all -> 0x0197 }
            ...
            L_0x00b2:
                ...
                long r11 = r2.f1356id     // Catch:{ all -> 0x0197 }
            ...
            L_0x00c6:
                ...
                long r11 = r11.f1356id     // Catch:{ all -> 0x0197 }
            ...
            L_0x00d9:
                ...
                r2 = r5[r0]     // Catch:{ all -> 0x0197 }
                long r8 = r2.f1356id     // Catch:{ all -> 0x0197 }
            ...
            L_0x0106:
                ...
                goto L_0x0129
            L_0x0109:
                java.lang.Object r13 = p030rx.internal.operators.NotificationLite.getValue(r11)     // Catch:{ all -> 0x0197 }
            ...
            L_0x0117:
                r0 = move-exception
                r2 = r0
                p030rx.exceptions.Exceptions.throwIfFatal(r2)     // Catch:{ all -> 0x005b }
            ...
            L_0x016a:
                ...
                long r9 = r0.f1356id     // Catch:{ all -> 0x0197 }
            ...
            L_0x01a3:
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.operators.OperatorMerge.MergeSubscriber.emitLoop():void");
        }
