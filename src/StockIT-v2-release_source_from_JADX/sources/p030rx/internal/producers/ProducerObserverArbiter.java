package p030rx.internal.producers;
...
public final class ProducerObserverArbiter<T> implements Producer, Observer<T> {
    ...
    public void onNext(T r5) {
        ...
        L_0x003d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.producers.ProducerObserverArbiter.onNext(java.lang.Object):void");
    }
    ...
    public void request(long r7) {
        ...
        L_0x0009:
            monitor-enter(r6)
            boolean r2 = r6.emitting     // Catch:{ all -> 0x003c }
            if (r2 == 0) goto L_0x0015
            long r0 = r6.missedRequested     // Catch:{ all -> 0x003c }
            long r0 = r0 + r7
            r6.missedRequested = r0     // Catch:{ all -> 0x003c }
            monitor-exit(r6)     // Catch:{ all -> 0x003c }
            return
        L_0x0015:
            r2 = 1
            r6.emitting = r2     // Catch:{ all -> 0x003c }
            monitor-exit(r6)     // Catch:{ all -> 0x003c }
            rx.Producer r2 = r6.currentProducer
            long r3 = r6.requested     // Catch:{ all -> 0x0032 }
            long r3 = r3 + r7
            int r5 = (r3 > r0 ? 1 : (r3 == r0 ? 0 : -1))
            if (r5 >= 0) goto L_0x0027
            r3 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
        L_0x0027:
            r6.requested = r3     // Catch:{ all -> 0x0032 }
            r6.emitLoop()     // Catch:{ all -> 0x0032 }
        ...
        L_0x0032:
            ...
            monitor-enter(r6)
            r8 = 0
            r6.emitting = r8     // Catch:{ all -> 0x0039 }
        ...
        L_0x003f:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.producers.ProducerObserverArbiter.request(long):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void setProducer(p030rx.Producer r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x002f:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.producers.ProducerObserverArbiter.setProducer(rx.Producer):void");
    }
