...
import p030rx.internal.operators.CompletableFlatMapSingleToCompletable;
import p030rx.internal.operators.SingleDelay;
import p030rx.internal.operators.SingleDoAfterTerminate;
import p030rx.internal.operators.SingleDoOnEvent;
import p030rx.internal.operators.SingleDoOnSubscribe;
import p030rx.internal.operators.SingleDoOnUnsubscribe;
import p030rx.internal.operators.SingleFromCallable;
import p030rx.internal.operators.SingleFromEmitter;
import p030rx.internal.operators.SingleFromFuture;
import p030rx.internal.operators.SingleFromObservable;
import p030rx.internal.operators.SingleLiftObservableOperator;
import p030rx.internal.operators.SingleObserveOn;
import p030rx.internal.operators.SingleOnErrorReturn;
import p030rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p030rx.internal.operators.SingleOnSubscribeMap;
import p030rx.internal.operators.SingleOnSubscribeUsing;
import p030rx.internal.operators.SingleOperatorCast;
import p030rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p030rx.internal.operators.SingleOperatorZip;
import p030rx.internal.operators.SingleTakeUntilCompletable;
import p030rx.internal.operators.SingleTakeUntilObservable;
import p030rx.internal.operators.SingleTakeUntilSingle;
import p030rx.internal.operators.SingleTimeout;
import p030rx.internal.operators.SingleToObservable;
import p030rx.internal.util.ScalarSynchronousSingle;
...
import p030rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    @Deprecated
    protected Single(Observable.OnSubscribe<T> onSubscribe2) {
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                C36121 r0 = new SingleSubscriber<Single<? extends T>>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        C36011 r0 = new SingleSubscriber<T>() {
                            public void onSuccess(T t) {
                                try {
    ...
    /* renamed from: to */
    public final <R> R mo48465to(Func1<? super Single<T>, R> func1) {
    ...
    public final Single<T> unsubscribeOn(final Scheduler scheduler) {
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                final C36081 r0 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        singleSubscriber.onSuccess(t);
                    }
