...
import p030rx.internal.operators.CompletableFromEmitter;
import p030rx.internal.operators.CompletableOnSubscribeConcat;
import p030rx.internal.operators.CompletableOnSubscribeConcatArray;
import p030rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p030rx.internal.operators.CompletableOnSubscribeMerge;
import p030rx.internal.operators.CompletableOnSubscribeMergeArray;
import p030rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p030rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p030rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p030rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p030rx.observers.SafeCompletableSubscriber;
...
import p030rx.subscriptions.MultipleAssignmentSubscription;
...
public class Completable {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                C35761 r2 = new CompletableSubscriber() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    C35891 r3 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C35391 r0 = new Subscriber<Object>() {
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C35411 r0 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) mo48081to(transformer);
    }
    ...
    public final Completable timeout(long j, TimeUnit timeUnit) {
        return timeout0(j, timeUnit, Schedulers.computation(), (Completable) null);
    }
    ...
    public final Completable timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout0(j, timeUnit, scheduler, (Completable) null);
    }
    ...
    /* renamed from: to */
    public final <R> R mo48081to(Func1<? super Completable, R> func1) {
