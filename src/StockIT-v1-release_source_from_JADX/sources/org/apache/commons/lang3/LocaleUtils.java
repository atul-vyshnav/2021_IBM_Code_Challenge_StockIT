...
public class LocaleUtils {
    ...
    public static List<Locale> languagesByCountry(String str) {
        ...
        for (Locale next : availableLocaleList()) {
            if (str.equals(next.getCountry()) && next.getVariant().isEmpty()) {
                arrayList.add(next);
            }
        }
    ...
    public static List<Locale> countriesByLanguage(String str) {
        ...
        ArrayList arrayList = new ArrayList();
        for (Locale next : availableLocaleList()) {
            if (str.equals(next.getLanguage()) && !next.getCountry().isEmpty() && next.getVariant().isEmpty()) {
                arrayList.add(next);
            }
        }
