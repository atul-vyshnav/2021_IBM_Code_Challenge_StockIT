...
public class OverridingUtil {
    ...
    public OverrideCompatibilityInfo isOverridableBy(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, ClassDescriptor classDescriptor, boolean z) {
        ...
        for (ExternalOverridabilityCondition next : EXTERNAL_CONDITIONS) {
            if (next.getContract() != ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY && (!z2 || next.getContract() != ExternalOverridabilityCondition.Contract.SUCCESS_ONLY)) {
                int i = C33348.f1292x42e2f52f[next.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i == 1) {
                    z2 = true;
                } else if (i == 2) {
        ...
        for (ExternalOverridabilityCondition next2 : EXTERNAL_CONDITIONS) {
            if (next2.getContract() == ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY) {
                int i2 = C33348.f1292x42e2f52f[next2.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i2 == 1) {
    ...
    private Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext> createTypeChecker(List<TypeParameterDescriptor> list, List<TypeParameterDescriptor> list2) {
        if (list == null) {
            $$$reportNull$$$0(40);
        }
        if (list2 == null) {
    ...
    private boolean areTypesEquivalent(KotlinType kotlinType, KotlinType kotlinType2, Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext> pair) {
        if (kotlinType == null) {
            $$$reportNull$$$0(44);
        }
        if (kotlinType2 == null) {
    ...
    private Collection<CallableMemberDescriptor> extractAndBindOverridesForMember(CallableMemberDescriptor callableMemberDescriptor, Collection<? extends CallableMemberDescriptor> collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collection) {
            ...
            int i = C33348.f1293xb0ae9f3b[result.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C33348 {
        ...
        static {
            ...
            L_0x0044:
                int[] r4 = f1293xb0ae9f3b     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                int[] r4 = f1293xb0ae9f3b     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0069:
                int[] r1 = f1292x42e2f52f     // Catch:{ NoSuchFieldError -> 0x0073 }
            ...
            L_0x0073:
                int[] r0 = f1292x42e2f52f     // Catch:{ NoSuchFieldError -> 0x007d }
            ...
            L_0x007d:
                int[] r0 = f1292x42e2f52f     // Catch:{ NoSuchFieldError -> 0x0087 }
            ...
            L_0x0087:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.C33348.<clinit>():void");
        }
    }
    ...
    private static Modality determineModalityForFakeOverride(Collection<CallableMemberDescriptor> collection, ClassDescriptor classDescriptor) {
        ...
        for (CallableMemberDescriptor next : collection) {
            int i = C33348.$SwitchMap$org$jetbrains$kotlin$descriptors$Modality[next.getModality().ordinal()];
            if (i == 1) {
