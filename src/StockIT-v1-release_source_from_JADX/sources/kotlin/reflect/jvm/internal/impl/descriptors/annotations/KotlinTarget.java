...
public enum KotlinTarget {
    ...
    FILE(UriUtil.LOCAL_FILE_SCHEME, false),
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m1160to(AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER, VALUE_PARAMETER), TuplesKt.m1160to(AnnotationUseSiteTarget.FIELD, FIELD), TuplesKt.m1160to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.m1160to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.m1160to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.m1160to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.m1160to(AnnotationUseSiteTarget.RECEIVER, VALUE_PARAMETER), TuplesKt.m1160to(AnnotationUseSiteTarget.SETTER_PARAMETER, VALUE_PARAMETER), TuplesKt.m1160to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, FIELD));
    }
