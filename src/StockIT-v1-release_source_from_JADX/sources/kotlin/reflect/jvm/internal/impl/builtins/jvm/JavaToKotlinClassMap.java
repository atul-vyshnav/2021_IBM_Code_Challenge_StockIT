...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        while (true) {
            ...
            INSTANCE.addKotlinToJava(new FqName(Intrinsics.stringPlus(functionClassKind.getPackageFqName().toString() + '.' + functionClassKind.getClassNamePrefix(), Integer.valueOf(i))), K_FUNCTION_CLASS_ID);
            if (i5 >= 22) {
