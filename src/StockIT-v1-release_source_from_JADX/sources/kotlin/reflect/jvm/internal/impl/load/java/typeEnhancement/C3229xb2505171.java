...
final class C3229xb2505171 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFBiConsumer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C3229xb2505171(String str) {
        super(1);
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFBiConsumer, PredefinedEnhancementInfoKt.NOT_PLATFORM, PredefinedEnhancementInfoKt.NOT_PLATFORM, PredefinedEnhancementInfoKt.NOT_PLATFORM);
    }
}
