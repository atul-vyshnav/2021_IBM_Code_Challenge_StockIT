...
public final class TypeIntersector {
    ...
    private final SimpleType intersectTypesWithoutIntersectionType(Set<? extends SimpleType> set) {
        ...
        Function0 typeIntersector$intersectTypesWithoutIntersectionType$errorMessage$1 = new C3369x7a6103fb(set);
        Collection collection = set;
        Collection<SimpleType> filterTypes = filterTypes(collection, new C3370x702eebb8(this));
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            Collection<SimpleType> filterTypes2 = filterTypes(filterTypes, new C3371xc97d8c34(NewKotlinTypeChecker.Companion.getDefault()));
