...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f1275c;
    ...
    public LazyJavaClassDescriptor(kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r16, kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor r17, kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r18, kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r19) {
        ...
        L_0x0102:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r8 = r6.f1275c
        ...
        L_0x0118:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r1 = r6.f1275c
            kotlin.reflect.jvm.internal.impl.storage.StorageManager r1 = r1.getStorageManager()
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r3 = r6.f1275c
            ...
            r0.<init>(r1, r2, r15)
            r6.staticScope = r0
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r0 = r6.f1275c
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r1 = r6.jClass
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        for (JavaClassifierType transformJavaType : this.jClass.getPermittedTypes()) {
            ClassifierDescriptor declarationDescriptor = this.f1275c.getTypeResolver().transformJavaType(transformJavaType, attributes$default).getConstructor().getDeclarationDescriptor();
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        private final NotNullLazyValue<List<TypeParameterDescriptor>> parameters = this.this$0.f1275c.getStorageManager().createLazyValue(new C3214xbaf55d8a(this.this$0));
        ...
        public LazyJavaClassTypeConstructor(LazyJavaClassDescriptor lazyJavaClassDescriptor) {
            super(lazyJavaClassDescriptor.f1275c.getStorageManager());
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType transformJavaType = this.this$0.f1275c.getTypeResolver().transformJavaType(next, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, (TypeParameterDescriptor) null, 3, (Object) null));
                if (this.this$0.f1275c.getComponents().getSettings().getTypeEnhancementImprovements()) {
                    transformJavaType = this.this$0.f1275c.getComponents().getSignatureEnhancement().enhanceSuperType(transformJavaType, this.this$0.f1275c);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = this.this$0.f1275c.getComponents().getErrorReporter();
            ...
            return collection.isEmpty() ^ true ? CollectionsKt.toList(arrayList) : CollectionsKt.listOf(this.this$0.f1275c.getModule().getBuiltIns().getAnyType());
        }
        ...
        private final kotlin.reflect.jvm.internal.impl.types.KotlinType getPurelyImplementedSupertype() {
            ...
            L_0x0031:
                kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor r4 = r8.this$0
                kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r4 = r4.f1275c
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return this.this$0.f1275c.getComponents().getSupertypeLoopChecker();
        }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(JavaResolverCache javaResolverCache, ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f1275c;
