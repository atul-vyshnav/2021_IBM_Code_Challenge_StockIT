...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f1278c;
    /* access modifiers changed from: private */
    public final JavaPackage jPackage;
    private final NotNullLazyValue partToFacade$delegate;
    private final JvmPackageScope scope = new JvmPackageScope(this.f1278c, this.jPackage, this);
    private final NotNullLazyValue<List<FqName>> subPackages = this.f1278c.getStorageManager().createRecursionTolerantLazyValue(new LazyJavaPackageFragment$subPackages$1(this), CollectionsKt.emptyList());
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext lazyJavaResolverContext, JavaPackage javaPackage) {
        ...
        this.f1278c = childForClassOrPackage$default;
        ...
        if (this.f1278c.getComponents().getJavaTypeEnhancementState().getDisabledDefaultAnnotations()) {
            annotations2 = Annotations.Companion.getEMPTY();
        } else {
            annotations2 = LazyJavaAnnotationsKt.resolveAnnotations(this.f1278c, this.jPackage);
        }
        this.annotations = annotations2;
        this.partToFacade$delegate = this.f1278c.getStorageManager().createLazyValue(new LazyJavaPackageFragment$partToFacade$2(this));
    }
