            ...
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (observableProperty == null) {
                    ...
                    if (!_Assertions.ENABLED || startsWith$default) {
                        ...
                        field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(observableProperty.getValue(this, new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(DescriptorRendererOptionsImpl.class), name2, Intrinsics.stringPlus("get", StringsKt.capitalize(name3))))));
                    } else {
