...
public final class MemberDeserializer {
    ...
    /* renamed from: c */
    public final DeserializationContext f1294c;
    ...
    public MemberDeserializer(DeserializationContext deserializationContext) {
        ...
        this.f1294c = deserializationContext;
        this.annotationDeserializer = new AnnotationDeserializer(deserializationContext.getComponents().getModuleDescriptor(), this.f1294c.getComponents().getNotFoundClasses());
    }
    ...
    public final PropertyDescriptor loadProperty(ProtoBuf.Property property) {
        ...
        DeclarationDescriptor containingDeclaration = this.f1294c.getContainingDeclaration();
        ...
        Name name = NameResolverUtilKt.getName(this.f1294c.getNameResolver(), property.getName());
        ...
        DeserializedPropertyDescriptor deserializedPropertyDescriptor2 = new DeserializedPropertyDescriptor(containingDeclaration, (PropertyDescriptor) null, annotations2, modality, descriptorVisibility, booleanValue, name, memberKind, booleanValue2, booleanValue3, booleanValue4, booleanValue5, bool6.booleanValue(), property, this.f1294c.getNameResolver(), this.f1294c.getTypeTable(), this.f1294c.getVersionRequirementTable(), this.f1294c.getContainerSource());
        DeserializationContext deserializationContext = this.f1294c;
        ...
        KotlinType type2 = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(property4, this.f1294c.getTypeTable()));
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(property4, this.f1294c.getTypeTable());
        ...
        if (bool16.booleanValue()) {
            deserializedPropertyDescriptor3.setCompileTimeInitializer(this.f1294c.getStorageManager().createNullableLazyValue(new MemberDeserializer$loadProperty$3(this, property4, deserializedPropertyDescriptor3)));
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:82:0x00ce A[SYNTHETIC] */
    ...
    private final kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedMemberDescriptor.CoroutinesCompatibilityMode computeExperimentalityModeForFunctions(kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedCallableMemberDescriptor r4, kotlin.reflect.jvm.internal.impl.descriptors.ReceiverParameterDescriptor r5, java.util.Collection<? extends kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor> r6, java.util.Collection<? extends kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor> r7, kotlin.reflect.jvm.internal.impl.types.KotlinType r8, boolean r9) {
        ...
        L_0x0153:
            ...
            java.lang.Iterable r6 = (java.lang.Iterable) r6
            java.lang.Comparable r4 = kotlin.collections.CollectionsKt.maxOrNull(r6)
    ...
    private final boolean versionAndReleaseCoroutinesMismatch(DeserializedMemberDescriptor deserializedMemberDescriptor) {
        boolean z;
        boolean z2;
        if (!this.f1294c.getComponents().getConfiguration().getReleaseCoroutines()) {
            return false;
        }
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function function) {
        ...
        if (Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(this.f1294c.getContainingDeclaration()).child(NameResolverUtilKt.getName(this.f1294c.getNameResolver(), function.getName())), (Object) SuspendFunctionTypeUtilKt.KOTLIN_SUSPEND_BUILT_IN_FUNCTION_FQ_NAME)) {
            versionRequirementTable = VersionRequirementTable.Companion.getEMPTY();
        } else {
            versionRequirementTable = this.f1294c.getVersionRequirementTable();
        }
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(this.f1294c.getContainingDeclaration(), (SimpleFunctionDescriptor) null, annotations2, NameResolverUtilKt.getName(this.f1294c.getNameResolver(), function.getName()), ProtoEnumFlagsUtilsKt.memberKind(ProtoEnumFlags.INSTANCE, Flags.MEMBER_KIND.get(flags)), function, this.f1294c.getNameResolver(), this.f1294c.getTypeTable(), versionRequirementTable, this.f1294c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
        DeserializationContext deserializationContext = this.f1294c;
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(function2, this.f1294c.getTypeTable());
        if (receiverType == null || (type = childContext$default.getTypeDeserializer().type(receiverType)) == null) {
            receiverParameterDescriptor = null;
        } else {
        ...
        KotlinType type2 = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(function2, this.f1294c.getTypeTable()));
        Modality modality = ProtoEnumFlags.INSTANCE.modality(Flags.MODALITY.get(flags));
        DescriptorVisibility descriptorVisibility = ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(flags));
        ...
        Pair<CallableDescriptor.UserDataKey<?>, Object> deserializeContractFromFunction = this.f1294c.getComponents().getContractDeserializer().deserializeContractFromFunction(function2, deserializedSimpleFunctionDescriptor3, this.f1294c.getTypeTable(), deserializationContext2.getTypeDeserializer());
    ...
    public final TypeAliasDescriptor loadTypeAlias(ProtoBuf.TypeAlias typeAlias) {
        ...
        for (ProtoBuf.Annotation annotation : iterable) {
            ...
            arrayList.add(annotationDeserializer2.deserializeAnnotation(annotation, this.f1294c.getNameResolver()));
        }
        DeserializedTypeAliasDescriptor deserializedTypeAliasDescriptor = new DeserializedTypeAliasDescriptor(this.f1294c.getStorageManager(), this.f1294c.getContainingDeclaration(), companion.create((List) arrayList), NameResolverUtilKt.getName(this.f1294c.getNameResolver(), typeAlias.getName()), ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(typeAlias.getFlags())), typeAlias, this.f1294c.getNameResolver(), this.f1294c.getTypeTable(), this.f1294c.getVersionRequirementTable(), this.f1294c.getContainerSource());
        List<ProtoBuf.TypeParameter> typeParameterList = typeAlias.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f1294c, deserializedTypeAliasDescriptor, typeParameterList, (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null);
        deserializedTypeAliasDescriptor.initialize(childContext$default.getTypeDeserializer().getOwnTypeParameters(), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.underlyingType(typeAlias2, this.f1294c.getTypeTable()), false), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.expandedType(typeAlias2, this.f1294c.getTypeTable()), false), checkExperimentalCoroutine(deserializedTypeAliasDescriptor, childContext$default.getTypeDeserializer()));
    ...
    public final ClassConstructorDescriptor loadConstructor(ProtoBuf.Constructor constructor, boolean z) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) this.f1294c.getContainingDeclaration();
        MessageLite messageLite = constructor2;
        DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor2 = new DeserializedClassConstructorDescriptor(classDescriptor, (ConstructorDescriptor) null, getAnnotations(messageLite, constructor.getFlags(), AnnotatedCallableKind.FUNCTION), z, CallableMemberDescriptor.Kind.DECLARATION, constructor, this.f1294c.getNameResolver(), this.f1294c.getTypeTable(), this.f1294c.getVersionRequirementTable(), this.f1294c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
        MemberDeserializer memberDeserializer = DeserializationContext.childContext$default(this.f1294c, deserializedClassConstructorDescriptor2, CollectionsKt.emptyList(), (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null).getMemberDeserializer();
        ...
        if (!Intrinsics.areEqual((Object) bool, (Object) true) || !versionAndReleaseCoroutinesMismatch(deserializedClassConstructorDescriptor2)) {
            z2 = false;
        }
        if (z2) {
    ...
    private final Annotations getAnnotations(MessageLite messageLite, int i, AnnotatedCallableKind annotatedCallableKind) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f1294c.getStorageManager(), new MemberDeserializer$getAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final Annotations getPropertyFieldAnnotations(ProtoBuf.Property property, boolean z) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f1294c.getStorageManager(), new MemberDeserializer$getPropertyFieldAnnotations$1(this, z, property));
    }
    ...
    private final Annotations getReceiverParameterAnnotations(MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        return new DeserializedAnnotations(this.f1294c.getStorageManager(), new MemberDeserializer$getReceiverParameterAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final java.util.List<kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor> valueParameters(java.util.List<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.ValueParameter> r26, kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r27, kotlin.reflect.jvm.internal.impl.serialization.deserialization.AnnotatedCallableKind r28) {
        /*
            r25 = this;
            r7 = r25
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r0 = r7.f1294c
        ...
        L_0x008e:
            ...
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r1 = r7.f1294c
            ...
            goto L_0x00f6
        L_0x00ec:
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r2 = r7.f1294c
    ...
    public final ProtoContainer asProtoContainer(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            return new ProtoContainer.Package(((PackageFragmentDescriptor) declarationDescriptor).getFqName(), this.f1294c.getNameResolver(), this.f1294c.getTypeTable(), this.f1294c.getContainerSource());
        }
