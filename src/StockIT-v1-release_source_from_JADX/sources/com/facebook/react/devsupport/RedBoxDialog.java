    ...
    private static class StackAdapter extends BaseAdapter {
        ...
        private static class FrameViewHolder {
            ...
            private FrameViewHolder(View view) {
                this.mMethodView = (TextView) view.findViewById(C1045R.C1048id.rn_frame_method);
                this.mFileView = (TextView) view.findViewById(C1045R.C1048id.rn_frame_file);
            }
        }
        ...
        public android.view.View getView(int r3, android.view.View r4, android.view.ViewGroup r5) {
            ...
            L_0x0008:
                ...
                int r4 = com.facebook.react.C1045R.layout.redbox_item_title
            ...
            L_0x002b:
                ...
                int r1 = com.facebook.react.C1045R.layout.redbox_item_frame
    ...
    private static class OpenStackFrameTask extends AsyncTask<StackFrame, Void, Void> {
        ...
        public Void doInBackground(StackFrame... stackFrameArr) {
            try {
                ...
                FLog.m65e(ReactConstants.TAG, "Could not open stack frame", (Throwable) e);
            }
            return null;
        }

        private static JSONObject stackFrameToJson(StackFrame stackFrame) {
            return new JSONObject(MapBuilder.m143of(UriUtil.LOCAL_FILE_SCHEME, stackFrame.getFile(), "methodName", stackFrame.getMethod(), StackTraceHelper.LINE_NUMBER_KEY, Integer.valueOf(stackFrame.getLine()), StackTraceHelper.COLUMN_KEY, Integer.valueOf(stackFrame.getColumn())));
        }
    }

    protected RedBoxDialog(Context context, DevSupportManager devSupportManager, RedBoxHandler redBoxHandler) {
        super(context, C1045R.style.Theme_Catalyst_RedBox);
        requestWindowFeature(1);
        setContentView(C1045R.layout.redbox_view);
        this.mDevSupportManager = devSupportManager;
        this.mDoubleTapReloadRecognizer = new DoubleTapReloadRecognizer();
        this.mRedBoxHandler = redBoxHandler;
        ListView listView = (ListView) findViewById(C1045R.C1048id.rn_redbox_stack);
        this.mStackView = listView;
        listView.setOnItemClickListener(this);
        Button button = (Button) findViewById(C1045R.C1048id.rn_redbox_reload_button);
        ...
        Button button2 = (Button) findViewById(C1045R.C1048id.rn_redbox_dismiss_button);
        ...
        if (redBoxHandler2 != null && redBoxHandler2.isReportEnabled()) {
            this.mLoadingIndicator = (ProgressBar) findViewById(C1045R.C1048id.rn_redbox_loading_indicator);
            this.mLineSeparator = findViewById(C1045R.C1048id.rn_redbox_line_separator);
            TextView textView = (TextView) findViewById(C1045R.C1048id.rn_redbox_report_label);
            this.mReportTextView = textView;
            textView.setMovementMethod(LinkMovementMethod.getInstance());
            this.mReportTextView.setHighlightColor(0);
            Button button3 = (Button) findViewById(C1045R.C1048id.rn_redbox_report_button);
