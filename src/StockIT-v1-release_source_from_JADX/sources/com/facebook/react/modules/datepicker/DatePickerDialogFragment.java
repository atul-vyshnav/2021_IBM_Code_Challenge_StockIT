...
public class DatePickerDialogFragment extends DialogFragment {
    ...
    static Dialog createDialog(Bundle bundle, Context context, DatePickerDialog.OnDateSetListener onDateSetListener) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            int i4 = C12261.$SwitchMap$com$facebook$react$modules$datepicker$DatePickerMode[datePickerMode2.ordinal()];
            if (i4 == 1) {
            ...
            int i5 = C12261.$SwitchMap$com$facebook$react$modules$datepicker$DatePickerMode[datePickerMode2.ordinal()];
            if (i5 == 1) {
    ...
    static /* synthetic */ class C12261 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.modules.datepicker.DatePickerDialogFragment.C12261.<clinit>():void");
        }
    }
