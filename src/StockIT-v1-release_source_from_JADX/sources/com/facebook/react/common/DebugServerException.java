...
public class DebugServerException extends RuntimeException {
    ...
    private DebugServerException(String str, String str2, int i, int i2) {
        super(str + "\n  at " + str2 + ParameterizedMessage.ERROR_MSG_SEPARATOR + i + ParameterizedMessage.ERROR_MSG_SEPARATOR + i2);
    }
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE), shortenFileName(jSONObject.getString("filename")), jSONObject.getInt(StackTraceHelper.LINE_NUMBER_KEY), jSONObject.getInt(StackTraceHelper.COLUMN_KEY));
        } catch (JSONException e) {
            FLog.m105w(ReactConstants.TAG, "Could not parse DebugServerException from: " + str2, (Throwable) e);
            return null;
        }
    }
