...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, NativeModuleCallExceptionHandler nativeModuleCallExceptionHandler) {
        ...
        FLog.m52d(ReactConstants.TAG, "Initializing React Xplat Bridge.");
        ...
        FLog.m52d(ReactConstants.TAG, "Initializing React Xplat Bridge before initializeBridge");
        ...
        FLog.m52d(ReactConstants.TAG, "Initializing React Xplat Bridge after initializeBridge");
        Systrace.endSection(0);
    ...
    public void runJSBundle() {
        FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.runJSBundle()");
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            ...
            FLog.m104w(ReactConstants.TAG, "Calling JS function after bridge has been destroyed: " + pendingJSCall2);
            return;
        }
    ...
    public void invokeCallback(int i, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            FLog.m104w(ReactConstants.TAG, "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public void destroy() {
        FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() start");
    ...
    public void destroyV1() {
        FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.destroyV1() start");
        UiThreadUtil.assertOnUiThread();
        if (!this.mDestroyed) {
                                ...
                                public void run() {
                                    AsyncTask.execute(new Runnable() {
                                        public void run() {
                                            ...
                                            FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.destroy() end");
    ...
    public void destroyV2() {
        FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.destroyV2() start");
        UiThreadUtil.assertOnUiThread();
        if (!this.mDestroyed) {
            ReactMarker.logMarker(ReactMarkerConstants.DESTROY_CATALYST_INSTANCE_START);
            this.mDestroyed = true;
            ...
            this.mNativeModulesQueueThread.runOnQueue(new Runnable() {
                public void run() {
                    FLog.m52d("CatalystInstanceImpl", ".destroy on native modules thread");
                    CatalystInstanceImpl.this.mNativeModuleRegistry.notifyJSInstanceDestroy();
                    CatalystInstanceImpl.this.mJSIModuleRegistry.notifyJSInstanceDestroy();
                    boolean z = false;
                    if (CatalystInstanceImpl.this.mPendingJSCalls.getAndSet(0) == 0) {
                    ...
                    FLog.m52d("CatalystInstanceImpl", ".destroy on native modules thread finished");
                }
            });
            getReactQueueConfiguration().getJSQueueThread().runOnQueue(new Runnable() {
                public void run() {
                    FLog.m52d("CatalystInstanceImpl", ".destroy on JS thread");
                    if (CatalystInstanceImpl.this.mTurboModuleManagerJSIModule != null) {
                        CatalystInstanceImpl.this.mTurboModuleManagerJSIModule.onCatalystInstanceDestroy();
                    }
                    boolean unused = CatalystInstanceImpl.this.mJSThreadDestructionComplete = true;
                    FLog.m52d("CatalystInstanceImpl", ".destroy on JS thread finished");
                }
            });
            ...
            while (true) {
                if (!this.mNativeModulesThreadDestructionComplete || !this.mJSThreadDestructionComplete) {
                    if (System.currentTimeMillis() - currentTimeMillis > 100) {
                        FLog.m104w(ReactConstants.TAG, "CatalystInstanceImpl.destroy() timed out waiting for Native Modules and JS thread teardown");
                        break;
                    }
                } else {
                    break;
    ...
    public void initialize() {
        FLog.m52d(ReactConstants.TAG, "CatalystInstanceImpl.initialize()");
    ...
    public void onNativeException(Exception exc) {
        FLog.m65e(ReactConstants.TAG, "CatalystInstanceImpl caught native exception", (Throwable) exc);
