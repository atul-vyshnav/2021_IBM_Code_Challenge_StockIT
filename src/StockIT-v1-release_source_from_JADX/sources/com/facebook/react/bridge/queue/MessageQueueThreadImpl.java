...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public void runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            FLog.m104w(ReactConstants.TAG, "Tried to enqueue runnable on already finished thread: '" + getName() + "... dropping Runnable.");
        }
    ...
    static /* synthetic */ class C11305 {
        ...
        static final /* synthetic */ int[] f97x16463f8b;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f97x16463f8b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.queue.MessageQueueThreadImpl.C11305.<clinit>():void");
        }
    }
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        int i = C11305.f97x16463f8b[messageQueueThreadSpec.getThreadType().ordinal()];
        if (i == 1) {
