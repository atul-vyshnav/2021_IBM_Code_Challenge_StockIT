...
public class ReactViewGroup extends ViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup {
    ...
    public void dispatchProvideStructure(ViewStructure viewStructure) {
        try {
            ...
            FLog.m65e(ReactConstants.TAG, "NullPointerException when executing dispatchProvideStructure", (Throwable) e);
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        try {
            ...
            FLog.m65e(ReactConstants.TAG, "NullPointerException when executing ViewGroup.dispatchDraw method", (Throwable) e);
                ...
                if (reactViewBackgroundDrawable != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= 17) {
                        ...
                        if (I18nUtil.getInstance().doLeftAndRightSwapInRTL(getContext())) {
                            float f7 = YogaConstants.isUndefined(borderRadius) ? f6 : borderRadius;
                            ...
                            if (YogaConstants.isUndefined(borderRadiusOrDefaultTo4)) {
                                borderRadiusOrDefaultTo4 = f5;
                            }
                            float f8 = z2 ? borderRadiusOrDefaultTo2 : f7;
                            if (z2) {
                                borderRadiusOrDefaultTo2 = f7;
                            }
                            float f9 = z2 ? borderRadiusOrDefaultTo4 : borderRadiusOrDefaultTo3;
                            if (z2) {
                            ...
                            float f10 = z2 ? borderRadiusOrDefaultTo4 : borderRadius3;
                            if (!z2) {
                            ...
                            borderRadiusOrDefaultTo4 = !YogaConstants.isUndefined(borderRadius3) ? borderRadius3 : f5;
                        }
                        f4 = 0.0f;
                    } else {
