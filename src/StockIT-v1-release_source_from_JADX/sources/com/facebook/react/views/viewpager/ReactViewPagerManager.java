...
public class ReactViewPagerManager extends ViewGroupManager<ReactViewPager> implements AndroidViewPagerManagerInterface<ReactViewPager> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m142of(PageScrollEvent.EVENT_NAME, MapBuilder.m140of("registrationName", "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m140of("registrationName", "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m140of("registrationName", "onPageSelected"));
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m141of("setPage", 1, "setPageWithoutAnimation", 2);
    }
