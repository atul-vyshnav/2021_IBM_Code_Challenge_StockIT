...
public class FabricJSIModuleProvider implements JSIModuleProvider<UIManager> {
    ...
    private final C1203ReactNativeConfig mConfig;
    private final JavaScriptContextHolder mJSContext;
    private final ReactApplicationContext mReactApplicationContext;

    public FabricJSIModuleProvider(ReactApplicationContext reactApplicationContext, JavaScriptContextHolder javaScriptContextHolder, ComponentFactoryDelegate componentFactoryDelegate, C1203ReactNativeConfig reactNativeConfig) {
    ...
    private static void loadClasses() {
        ...
        C1203ReactNativeConfig.class.getClass();
