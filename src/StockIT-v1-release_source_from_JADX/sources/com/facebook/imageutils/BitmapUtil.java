    ...
    static /* synthetic */ class C10321 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C10321.<clinit>():void");
        }
    }

    public static int getPixelSizeForBitmapConfig(Bitmap.Config config) {
        int i = C10321.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
