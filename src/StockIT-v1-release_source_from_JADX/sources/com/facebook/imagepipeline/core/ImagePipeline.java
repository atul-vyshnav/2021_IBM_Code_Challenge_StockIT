...
public class ImagePipeline {
    ...
    public void clearMemoryCaches() {
        C09625 r0 = new Predicate<CacheKey>() {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, (Object) null);
        int i = C09669.f91x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C09669 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f91x9ce557aa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.core.ImagePipeline.C09669.<clinit>():void");
        }
    }
