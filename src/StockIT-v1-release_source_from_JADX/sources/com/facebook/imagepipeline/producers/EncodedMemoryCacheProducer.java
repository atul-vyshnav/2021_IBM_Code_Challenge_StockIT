            ...
            if (closeableReference != null) {
                try {
                    ...
                    if (producerListener.requiresExtraMap(producerContext, PRODUCER_NAME)) {
                        map = ImmutableMap.m36of("cached_value_found", "true");
                    }
                ...
                producerListener.onProducerFinishWithSuccess(producerContext, PRODUCER_NAME, producerListener.requiresExtraMap(producerContext, PRODUCER_NAME) ? ImmutableMap.m36of("cached_value_found", "false") : null);
