    ...
    static /* synthetic */ class C08731 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C08731.<clinit>():void");
        }
    }

    public boolean asBoolean() {
        int i = C08731.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
