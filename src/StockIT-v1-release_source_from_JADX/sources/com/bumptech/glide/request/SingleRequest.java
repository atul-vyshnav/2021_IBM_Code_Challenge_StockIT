...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, FactoryPools.Poolable {
    ...
    private synchronized void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r11, R r12, com.bumptech.glide.load.DataSource r13) {
        /*
            r10 = this;
            monitor-enter(r10)
            boolean r6 = r10.isFirstReadyResource()     // Catch:{ all -> 0x00c3 }
            ...
            r10.status = r0     // Catch:{ all -> 0x00c3 }
            r10.resource = r11     // Catch:{ all -> 0x00c3 }
            com.bumptech.glide.GlideContext r11 = r10.glideContext     // Catch:{ all -> 0x00c3 }
            ...
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            java.lang.Object r1 = r10.model     // Catch:{ all -> 0x00c3 }
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            java.lang.String r1 = " with size ["
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            int r1 = r10.width     // Catch:{ all -> 0x00c3 }
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            java.lang.String r1 = "x"
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            int r1 = r10.height     // Catch:{ all -> 0x00c3 }
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            java.lang.String r1 = "] in "
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
            long r1 = r10.startTime     // Catch:{ all -> 0x00c3 }
            double r1 = com.bumptech.glide.util.LogTime.getElapsedMillis(r1)     // Catch:{ all -> 0x00c3 }
            r0.append(r1)     // Catch:{ all -> 0x00c3 }
        ...
        L_0x006c:
            r11 = 1
            r10.isCallingCallbacks = r11     // Catch:{ all -> 0x00c3 }
            r7 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r10.requestListeners     // Catch:{ all -> 0x00bf }
        ...
        L_0x007b:
            ...
            java.lang.Object r2 = r10.model     // Catch:{ all -> 0x00bf }
            com.bumptech.glide.request.target.Target<R> r3 = r10.target     // Catch:{ all -> 0x00bf }
            r1 = r12
            r4 = r13
            r5 = r6
        ...
        L_0x0094:
            r9 = 0
        L_0x0095:
            com.bumptech.glide.request.RequestListener<R> r0 = r10.targetListener     // Catch:{ all -> 0x00bf }
        ...
        L_0x00aa:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r11 = r10.animationFactory     // Catch:{ all -> 0x00bf }
            com.bumptech.glide.request.transition.Transition r11 = r11.build(r13, r6)     // Catch:{ all -> 0x00bf }
            com.bumptech.glide.request.target.Target<R> r13 = r10.target     // Catch:{ all -> 0x00bf }
            r13.onResourceReady(r12, r11)     // Catch:{ all -> 0x00bf }
        L_0x00b8:
            r10.isCallingCallbacks = r7     // Catch:{ all -> 0x00c3 }
            r10.notifyLoadSuccess()     // Catch:{ all -> 0x00c3 }
            monitor-exit(r10)
            return
        L_0x00bf:
            r11 = move-exception
