...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int i, RequestOptions requestOptions, Map<Class<?>, TransitionOptions<?, ?>> map, List<RequestListener<Object>> list, boolean z) {
        ...
        this.glideContext = new GlideContext(context, arrayPool2, this.registry, new ImageViewTargetFactory(), requestOptions, map, list, engine2, z, i);
    }
