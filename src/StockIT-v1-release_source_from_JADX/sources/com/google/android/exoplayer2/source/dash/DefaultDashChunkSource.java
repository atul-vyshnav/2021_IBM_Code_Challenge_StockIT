...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    private long liveEdgeTimeUs = C1379C.TIME_UNSET;
    ...
    public void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (this.fatalError == null) {
            ...
            long msToUs = C1379C.msToUs(this.manifest.availabilityStartTimeMs) + C1379C.msToUs(this.manifest.getPeriod(this.periodIndex).startMs) + j2;
            ...
            if (playerTrackEmsgHandler2 == null || !playerTrackEmsgHandler2.maybeRefreshManifestBeforeLoadingNextChunk(msToUs)) {
                ...
                long j6 = C1379C.TIME_UNSET;
                int i4 = (access$000 > C1379C.TIME_UNSET ? 1 : (access$000 == C1379C.TIME_UNSET ? 0 : -1));
                boolean z = i4 != 0;
    ...
    private void updateLiveEdgeTimeUs(RepresentationHolder representationHolder, long j) {
        this.liveEdgeTimeUs = this.manifest.dynamic ? representationHolder.getSegmentEndTimeUs(j) : C1379C.TIME_UNSET;
    }
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        if (this.manifest.dynamic && this.liveEdgeTimeUs != C1379C.TIME_UNSET) {
    ...
    public Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource2, int i, Format format, int i2, Object obj, long j, int i3, long j2) {
        ...
        long j4 = (access$000 == C1379C.TIME_UNSET || access$000 > segmentEndTimeUs) ? -9223372036854775807L : access$000;
    ...
    protected static final class RepresentationHolder {
        ...
        public long getFirstAvailableSegmentNum(DashManifest dashManifest, int i, long j) {
            if (getSegmentCount() != -1 || dashManifest.timeShiftBufferDepthMs == C1379C.TIME_UNSET) {
                return getFirstSegmentNum();
            }
            return Math.max(getFirstSegmentNum(), getSegmentNum(((j - C1379C.msToUs(dashManifest.availabilityStartTimeMs)) - C1379C.msToUs(dashManifest.getPeriod(i).startMs)) - C1379C.msToUs(dashManifest.timeShiftBufferDepthMs)));
        }
        ...
        public long getLastAvailableSegmentNum(DashManifest dashManifest, int i, long j) {
            ...
            if (segmentCount == -1) {
                firstSegmentNum = getSegmentNum((j - C1379C.msToUs(dashManifest.availabilityStartTimeMs)) - C1379C.msToUs(dashManifest.getPeriod(i).startMs));
            } else {
