...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    private long lastLoadedChunkEndTimeBeforeRefreshUs = C1379C.TIME_UNSET;
    private long lastLoadedChunkEndTimeUs = C1379C.TIME_UNSET;
    ...
    public boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        if (!(j != C1379C.TIME_UNSET && j < chunk.startTimeUs)) {
            return false;
        }
        maybeNotifyDashManifestRefreshNeeded();
        return true;
    ...
    public void onChunkLoadCompleted(Chunk chunk) {
        if (this.lastLoadedChunkEndTimeUs != C1379C.TIME_UNSET || chunk.endTimeUs > this.lastLoadedChunkEndTimeUs) {
            this.lastLoadedChunkEndTimeUs = chunk.endTimeUs;
        }
    }

    public static boolean isPlayerEmsgEvent(String str, String str2) {
        return "urn:mpeg:dash:event:2012".equals(str) && (BuildConfig.VERSION_NAME.equals(str2) || ExifInterface.GPS_MEASUREMENT_2D.equals(str2) || ExifInterface.GPS_MEASUREMENT_3D.equals(str2));
    }
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        ...
        if (j == C1379C.TIME_UNSET || j != this.lastLoadedChunkEndTimeUs) {
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (access$100 != C1379C.TIME_UNSET) {
