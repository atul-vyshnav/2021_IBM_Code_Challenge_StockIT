...
public final class TsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((timestampAdjuster.getTimestampOffsetUs() == C1379C.TIME_UNSET) || !(timestampAdjuster.getTimestampOffsetUs() == 0 || timestampAdjuster.getFirstSampleTimestampUs() == j2)) {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if ((readInt & 16) != 0) {
            tsPayloadReader = this.tsPayloadReaders.get(i);
        }
        ...
        if (this.mode != 2) {
            int i2 = readInt & 15;
            int i3 = this.continuityCounters.get(i, i2 - 1);
            this.continuityCounters.put(i, i2);
            if (i3 == i2) {
                this.tsPacketBuffer.setPosition(findEndOfFirstTsPacketInBuffer);
                return 0;
            } else if (i2 != ((i3 + 1) & 15)) {
    ...
    private void maybeOutputSeekMap(long j) {
        if (!this.hasOutputSeekMap) {
            ...
            if (this.durationReader.getDurationUs() != C1379C.TIME_UNSET) {
