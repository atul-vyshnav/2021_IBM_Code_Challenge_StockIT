...
public final class Mp3Extractor implements Extractor {
    ...
    private static final int SEEK_HEADER_INFO = Util.getIntegerCodeForString(Constants.BluetoothLogLevel.INFO);
    ...
    public Mp3Extractor(int i, long j) {
        ...
        this.basisTimeUs = C1379C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C1379C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C1379C.TIME_UNSET) {
