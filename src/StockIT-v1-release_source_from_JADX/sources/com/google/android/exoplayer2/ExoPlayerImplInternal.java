...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.SourceInfoRefreshListener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector2, TrackSelectorResult trackSelectorResult, LoadControl loadControl2, BandwidthMeter bandwidthMeter2, boolean z, int i, boolean z2, Handler handler2, ExoPlayer exoPlayer, Clock clock2) {
        ...
        this.playbackInfo = PlaybackInfo.createDummy(C1379C.TIME_UNSET, trackSelectorResult);
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        if (this.released) {
            Log.m173w(TAG, "Ignoring messages sent after release.");
    ...
    private void updatePlaybackPositions() throws ExoPlaybackException {
        if (this.queue.hasPlayingPeriod()) {
            ...
            if (readDiscontinuity != C1379C.TIME_UNSET) {
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        if (z2 && ((j == C1379C.TIME_UNSET || j <= this.playbackInfo.positionUs) && playingPeriod.info.isFinal)) {
            setState(4);
            stopRenderers();
    ...
    private void seekToInternal(com.google.android.exoplayer2.ExoPlayerImplInternal.SeekPosition r23) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x008c:
            r4 = r12
        L_0x008d:
            long r7 = com.google.android.exoplayer2.C1379C.usToMs(r4)     // Catch:{ all -> 0x00de }
            com.google.android.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00de }
            long r10 = r0.positionUs     // Catch:{ all -> 0x00de }
            long r10 = com.google.android.exoplayer2.C1379C.usToMs(r10)     // Catch:{ all -> 0x00de }
    ...
    private void sendMessageInternal(PlayerMessage playerMessage) throws ExoPlaybackException {
        if (playerMessage.getPositionMs() == C1379C.TIME_UNSET) {
    ...
    public /* synthetic */ void lambda$sendMessageToTargetThread$0$ExoPlayerImplInternal(PlayerMessage playerMessage) {
        try {
            ...
            Log.m170e(TAG, "Unexpected error delivering message on external thread.", e);
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        if (pendingMessageInfo.resolvedPeriodUid == null) {
            Pair<Object, Long> resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C1379C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
    ...
    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.info.durationUs;
        return j == C1379C.TIME_UNSET || this.playbackInfo.positionUs < j || (playingPeriod.next != null && (playingPeriod.next.prepared || playingPeriod.next.info.f121id.isAd()));
    }
            ...
            if (i > 0) {
                ...
                if (seekPosition != null) {
                    try {
                        ...
                        this.playbackInfo = this.playbackInfo.resetToNewPosition(this.playbackInfo.getDummyFirstMediaPeriodId(this.shuffleModeEnabled, this.window), C1379C.TIME_UNSET, C1379C.TIME_UNSET);
                        throw illegalSeekPositionException;
                    }
                } else if (this.playbackInfo.startPositionUs != C1379C.TIME_UNSET) {
                } else {
                    if (timeline2.isEmpty()) {
                        handleSourceInfoRefreshEndedPlayback();
                        return;
                    }
                    Pair<Object, Long> periodPosition = getPeriodPosition(timeline2, timeline2.getFirstWindowIndex(this.shuffleModeEnabled), C1379C.TIME_UNSET);
                ...
                if (timeline2.getIndexOfPeriod(obj4) == -1) {
                    ...
                    Pair<Object, Long> periodPosition2 = getPeriodPosition(timeline2, timeline2.getPeriodByUid(resolveSubsequentPeriod, this.period).windowIndex, C1379C.TIME_UNSET);
                    ...
                    if (frontPeriod != null) {
                        while (frontPeriod.next != null) {
                            ...
                            if (frontPeriod.info.f121id.equals(resolveMediaPeriodIdForAds3)) {
                ...
                Pair<Object, Long> periodPosition3 = getPeriodPosition(timeline2, timeline2.getFirstWindowIndex(this.shuffleModeEnabled), C1379C.TIME_UNSET);
    ...
    private Pair<Object, Long> resolveSeekPosition(SeekPosition seekPosition, boolean z) {
        ...
        try {
            ...
            return getPeriodPosition(timeline, timeline.getPeriod(indexOfPeriod, this.period).windowIndex, C1379C.TIME_UNSET);
                ...
                if (readingPeriod.info.isFinal) {
                    ...
                    while (true) {
                        ...
                        if (i3 < rendererArr2.length) {
                            ...
                            boolean z2 = advanceReadingPeriod.mediaPeriod.readDiscontinuity() != C1379C.TIME_UNSET;
                            int i4 = 0;
                            while (true) {
