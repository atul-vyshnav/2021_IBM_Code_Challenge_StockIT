...
public class OkHttpDataSource extends BaseDataSource implements HttpDataSource {
    ...
    private C3401Response response;
    ...
    public Uri getUri() {
        C3401Response response2 = this.response;
        if (response2 == null) {
            return null;
        }
    ...
    public long open(DataSpec dataSpec2) throws HttpDataSource.HttpDataSourceException {
        ...
        try {
            C3401Response execute = this.callFactory.newCall(makeRequest(dataSpec2)).execute();
            ...
            if (!execute.isSuccessful()) {
                ...
                HttpDataSource.InvalidResponseCodeException invalidResponseCodeException = new HttpDataSource.InvalidResponseCodeException(code, execute.message(), multimap, dataSpec2);
                if (code == 416) {
