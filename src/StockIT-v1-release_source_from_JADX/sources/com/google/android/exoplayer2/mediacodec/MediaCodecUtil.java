...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z) {
        try {
            ...
            Log.m170e(TAG, "Codec warming failed", e);
        }
    }
        ...
        synchronized (MediaCodecUtil.class) {
            ...
            if (z && decoderInfosInternal.isEmpty() && 21 <= Util.SDK_INT && Util.SDK_INT <= 23) {
                ...
                if (!decoderInfosInternal.isEmpty()) {
                    Log.m173w(TAG, "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + decoderInfosInternal.get(0).name);
                }
            }
    ...
    private static java.util.ArrayList<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> getDecoderInfosInternal(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r17, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r18, java.lang.String r19) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        ...
        L_0x0082:
            ...
            com.google.android.exoplayer2.util.Log.m169e(r7, r0)     // Catch:{ Exception -> 0x00e1 }
            goto L_0x00ce
        L_0x00aa:
            ...
            com.google.android.exoplayer2.util.Log.m169e(r7, r1)     // Catch:{ Exception -> 0x00e1 }
    ...
    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr) {
        int i;
        if (strArr.length < 4) {
            Log.m173w(TAG, "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        ...
        if (BuildConfig.VERSION_NAME.equals(group)) {
            i = 1;
        } else if (ExifInterface.GPS_MEASUREMENT_2D.equals(group)) {
            i = 2;
        } else {
            Log.m173w(TAG, "Unknown HEVC profile string: " + group);
            return null;
        }
        ...
        Log.m173w(TAG, "Unknown HEVC level string: " + matcher.group(1));
        return null;
    }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        Integer num2;
        if (strArr.length < 2) {
            Log.m173w(TAG, "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            if (i == -1) {
                Log.m173w(TAG, "Unknown AVC profile: " + num2);
                return null;
            }
            ...
            Log.m173w(TAG, "Unknown AVC level: " + num);
            return null;
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        int i;
        if (strArr.length != 3) {
            Log.m173w(TAG, "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
