...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x009a, code lost:
        if (compareFormatValues(r2.bitrate, r10) < 0) goto L_0x009f;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* access modifiers changed from: protected */
    public Pair<TrackSelection, AudioTrackScore> selectAudioTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i, Parameters parameters, TrackSelection.Factory factory) throws ExoPlaybackException {
        TrackGroupArray trackGroupArray2 = trackGroupArray;
        Parameters parameters2 = parameters;
    ...
    public Pair<TrackSelection, Integer> selectTextTrack(TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) throws ExoPlaybackException {
        ...
        return Pair.create(new FixedTrackSelection(trackGroup, i), Integer.valueOf(i2));
    }
    ...
    protected static boolean formatHasNoLanguage(Format format) {
        return TextUtils.isEmpty(format.language) || formatHasLanguage(format, C1379C.LANGUAGE_UNDETERMINED);
    }
