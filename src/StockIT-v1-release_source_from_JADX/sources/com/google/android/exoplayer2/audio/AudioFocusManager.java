...
public final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes2) {
        ...
        switch (audioAttributes2.usage) {
            case 0:
                Log.m173w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 16:
                ...
                return 2;
            default:
                Log.m173w(TAG, "Unidentified audio usage: " + audioAttributes2.usage);
                return 0;
        }
        return 3;
    }
        ...
        public void onAudioFocusChange(int i) {
            if (i != -3) {
                if (i == -2) {
                    ...
                    Log.m173w(AudioFocusManager.TAG, "Unknown focus change type: " + i);
                    return;
                } else {
