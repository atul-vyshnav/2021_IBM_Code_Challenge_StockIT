...
final class CachedContent {
    ...
    public void writeToStream(DataOutputStream dataOutputStream) throws IOException {
        dataOutputStream.writeInt(this.f153id);
    ...
    public SimpleCacheSpan touch(SimpleCacheSpan simpleCacheSpan) throws Cache.CacheException {
        SimpleCacheSpan copyWithUpdatedLastAccessTime = simpleCacheSpan.copyWithUpdatedLastAccessTime(this.f153id);
    ...
    public int headerHashCode(int i) {
        int i2;
        int i3;
        int hashCode = (this.f153id * 31) + this.key.hashCode();
        if (i < 2) {
