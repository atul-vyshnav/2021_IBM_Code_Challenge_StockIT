...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1577R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1577R.styleable.MaterialButtonToggleGroup, i, C1577R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C1577R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C1577R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
