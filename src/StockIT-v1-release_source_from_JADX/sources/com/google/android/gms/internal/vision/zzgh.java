...
final class zzgh extends zzgf<zzgs.zzd> {
        ...
        if (!zzg.zzxb.zzwi || !zzg.zzxb.zzwj) {
            ...
            switch (zzgg.zzrr[zzg.zzxb.zzwh.ordinal()]) {
                ...
                case 14:
                    arrayList = new ArrayList();
                    zzis.zzl(arrayList);
                    ub = zzit.zza(i, (List<Integer>) arrayList, zzg.zzxb.zzwg, ub, zzjj);
                    break;
                default:
            ...
            zzgi.zza(zzg.zzxb, (Object) arrayList);
        }
        return ub;
    }
    ...
    public final void zza(zzkg zzkg, Map.Entry<?, ?> entry) throws IOException {
        ...
        if (zzd.zzwi) {
            switch (zzgg.zzrr[zzd.zzwh.ordinal()]) {
                case 1:
                    zzit.zza(zzd.number, (List<Double>) (List) entry.getValue(), zzkg, zzd.zzwj);
                    return;
                case 2:
                    zzit.zzb(zzd.number, (List<Float>) (List) entry.getValue(), zzkg, zzd.zzwj);
                    return;
                case 3:
                ...
                case 15:
                    ...
                    return;
                case 16:
                    zzit.zza(zzd.number, (List<String>) (List) entry.getValue(), zzkg);
                    return;
                case 17:
                    List list = (List) entry.getValue();
                    if (list != null && !list.isEmpty()) {
                        zzit.zzb(zzd.number, (List<?>) (List) entry.getValue(), zzkg, (zzir) zzin.zzho().zzf(list.get(0).getClass()));
                        return;
                    }
                    return;
                case 18:
                    ...
                    if (list2 != null && !list2.isEmpty()) {
                        zzit.zza(zzd.number, (List<?>) (List) entry.getValue(), zzkg, (zzir) zzin.zzho().zzf(list2.get(0).getClass()));
                        return;
                    }
                    return;
                default:
            ...
            switch (zzgg.zzrr[zzd.zzwh.ordinal()]) {
                ...
                case 16:
                    ...
                    return;
                case 17:
                    zzkg.zzb(zzd.number, (Object) entry.getValue(), (zzir) zzin.zzho().zzf(entry.getValue().getClass()));
                    return;
                case 18:
                    zzkg.zza(zzd.number, (Object) entry.getValue(), (zzir) zzin.zzho().zzf(entry.getValue().getClass()));
                    return;
                default:
                    return;
            }
    ...
    public final void zza(zzis zzis, Object obj, zzgd zzgd, zzgi<zzgs.zzd> zzgi) throws IOException {
        zzgs.zzg zzg = (zzgs.zzg) obj;
        zzgi.zza(zzg.zzxb, (Object) zzis.zza(zzg.zzxa.getClass(), zzgd));
    }
