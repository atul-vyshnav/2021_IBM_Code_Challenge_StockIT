...
public final class zzbne implements zzeoy<Set<zzcab<zzp>>> {
    ...
    private zzbne(zzeph<zzbmu> zzeph, zzeph<Executor> zzeph2, zzeph<JSONObject> zzeph3) {
        this.zzfop = zzeph;
        this.zzesr = zzeph2;
        this.zzfoq = zzeph3;
    }

    public static zzbne zze(zzeph<zzbmu> zzeph, zzeph<Executor> zzeph2, zzeph<JSONObject> zzeph3) {
        return new zzbne(zzeph, zzeph2, zzeph3);
    }
