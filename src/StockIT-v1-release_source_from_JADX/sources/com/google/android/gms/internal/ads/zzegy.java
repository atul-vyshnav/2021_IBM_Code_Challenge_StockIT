...
public final class zzegy {
    ...
    public static ECParameterSpec zza(zzeha zzeha) throws NoSuchAlgorithmException {
        int i = zzegx.zzicn[zzeha.ordinal()];
        if (i == 1) {
        ...
        String valueOf = String.valueOf(zzeha);
    ...
    public static ECPublicKey zza(zzeha zzeha, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzeha);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        zza(eCPoint, zza.getCurve());
        return (ECPublicKey) zzehb.zzidd.zzhs("EC").generatePublic(new ECPublicKeySpec(eCPoint, zza));
    }

    public static KeyPair zza(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator zzhs = zzehb.zzidc.zzhs("EC");
    ...
    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        PublicKey generatePublic = zzehb.zzidd.zzhs("EC").generatePublic(new ECPublicKeySpec(eCPoint, eCPrivateKey.getParams()));
        KeyAgreement zzhs = zzehb.zzidb.zzhs("ECDH");
