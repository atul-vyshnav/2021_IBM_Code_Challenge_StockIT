...
final class zzenk extends zzenh {
    zzenk() {
    }
    ...
    public final int zzb(int r12, byte[] r13, int r14, int r15) {
        ...
        L_0x0023:
            ...
            int r12 = com.google.android.gms.internal.ads.zzeng.zzap(r8, r14)
            return r12
        L_0x0036:
            r10 = r14
            r14 = r12
        ...
        L_0x004a:
            ...
            int r12 = com.google.android.gms.internal.ads.zzeng.zzap(r8, r9)
            return r12
        L_0x005b:
            r14 = r12
            r12 = 0
        ...
        L_0x0061:
            ...
            int r12 = com.google.android.gms.internal.ads.zzeng.zzj(r8, r9, r14)
            return r12
        L_0x006e:
            r10 = r14
            r14 = r12
        ...
        L_0x00a8:
            ...
            int r12 = com.google.android.gms.internal.ads.zzeng.zzn(r13, r12, r15)
            return r12
        L_0x00b3:
            int r8 = r12 + 1
            byte r12 = r13[r12]
        ...
        L_0x00ed:
            ...
            goto L_0x0091
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzenk.zzb(int, byte[], int, int):int");
    }
            ...
            while (r13 < i3) {
                ...
                if (zzeni.zze(b2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        zzeni.zza(b3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (zzeni.zzf(b2)) {
                    if (i6 < i3) {
                        zzeni.zza(b2, bArr[i6], cArr, i5);
                        r13 = i6 + 1;
                        i5++;
                    } else {
                        throw zzekj.zzbhf();
                    }
                } else if (zzeni.zzg(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzeni.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        r13 = i8 + 1;
                        i5++;
                    } else {
                        throw zzekj.zzbhf();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzeni.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    r13 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzekj.zzbhf();
