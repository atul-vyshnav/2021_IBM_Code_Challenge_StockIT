...
final class zas implements zabs {
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        printWriter.append(str).append("authClient").println(ParameterizedMessage.ERROR_MSG_SEPARATOR);
        this.zaeg.dump(String.valueOf(str).concat("  "), fileDescriptor, printWriter, strArr);
        printWriter.append(str).append("anonClient").println(ParameterizedMessage.ERROR_MSG_SEPARATOR);
