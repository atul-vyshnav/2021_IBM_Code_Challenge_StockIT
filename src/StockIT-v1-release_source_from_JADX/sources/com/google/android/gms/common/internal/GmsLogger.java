...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo22458d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zza(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo22459d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo22467v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zza(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo22468v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo22463i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zza(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo22464i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo22469w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zza(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo22470w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo22460e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zza(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo22461e(String str, String str2, Throwable th) {
        if (canLog(6)) {
