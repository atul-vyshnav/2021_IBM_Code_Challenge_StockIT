...
public final class zzf extends zza {
    ...
    public zzf(Executor executor, Iterable<ComponentRegistrar> iterable, Component<?>... componentArr) {
        ...
        arrayList.add(Component.m1109of(this.zzc, zzh.class, Subscriber.class, Publisher.class));
        for (ComponentRegistrar components : iterable) {
            arrayList.addAll(components.getComponents());
        }
        Collections.addAll(arrayList, componentArr);
        List<T> unmodifiableList = Collections.unmodifiableList(Component.C21171.zza((List<Component<?>>) arrayList));
        this.zza = unmodifiableList;
        for (T zza2 : unmodifiableList) {
            zza(zza2);
        }
        zza();
    }
