...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (access$000 == 13) {
                    ...
                    throw new IllegalStateException("Expected a name but was " + jsonReader.peek() + StringUtils.SPACE + " at line " + jsonReader.getLineNumber() + " column " + jsonReader.getColumnNumber() + " path " + jsonReader.getPath());
                }
            }
        };
    }
    ...
    public long nextLong() throws IOException {
        ...
        if (i == 16) {
            ...
            String nextQuotedValue = nextQuotedValue(i == 8 ? '\'' : Typography.quote);
