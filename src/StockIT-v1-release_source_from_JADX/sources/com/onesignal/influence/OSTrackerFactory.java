...
public class OSTrackerFactory {
    ...
    static /* synthetic */ class C24331 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$onesignal$influence$model$OSInfluenceChannel     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.influence.OSTrackerFactory.C24331.<clinit>():void");
        }
    }

    public void addSessionData(JSONObject jSONObject, List<OSInfluence> list) {
        for (OSInfluence next : list) {
            if (C24331.$SwitchMap$com$onesignal$influence$model$OSInfluenceChannel[next.getInfluenceChannel().ordinal()] == 1) {
