...
class OSOutcomeEventsV1Repository extends OSOutcomeEventsRepository {
    ...
    /* renamed from: com.onesignal.outcomes.OSOutcomeEventsV1Repository$1 */
    static /* synthetic */ class C24351 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.outcomes.OSOutcomeEventsV1Repository.C24351.<clinit>():void");
        }
    }
    ...
    public void requestMeasureOutcomeEvent(String str, int i, OSOutcomeEventParams oSOutcomeEventParams, OneSignalApiResponseHandler oneSignalApiResponseHandler) {
        ...
        int i2 = C24351.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[fromOutcomeEventParamsV2toOutcomeEventV1.getSession().ordinal()];
        if (i2 == 1) {
