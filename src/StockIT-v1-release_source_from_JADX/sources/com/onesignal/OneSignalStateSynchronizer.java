...
class OneSignalStateSynchronizer {
    ...
    static void syncHashedEmail(String str) {
        try {
            ...
            jSONObject.put("em_m", OSUtils.hexDigest(str, MessageDigestAlgorithms.MD5));
            jSONObject.put("em_s", OSUtils.hexDigest(str, MessageDigestAlgorithms.SHA_1));
    ...
    static void setExternalUserId(String str, String str2, final OneSignal.OSExternalUserIdUpdateCompletionHandler oSExternalUserIdUpdateCompletionHandler) throws JSONException {
        ...
        C24001 r1 = new OneSignal.OSInternalExternalUserIdUpdateCompletionHandler() {
