...
public class OneSignalNotificationManager {
    ...
    static Integer getMostRecentNotifIdFromGroup(OneSignalDbHelper oneSignalDbHelper, String str, boolean z) {
        ...
        Cursor query = oneSignalDbHelper.query(OneSignalDbContract.NotificationTable.TABLE_NAME, (String[]) null, str2 + " AND dismissed = 0 AND opened = 0 AND is_summary = 0", z ? null : new String[]{str}, (String) null, (String) null, "created_time DESC", BuildConfig.VERSION_NAME);
