...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        C07111 r2 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void draw(Canvas canvas) {
        this.isDirty = false;
        C0692L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C0692L.endSection("Drawable#draw");
    }
