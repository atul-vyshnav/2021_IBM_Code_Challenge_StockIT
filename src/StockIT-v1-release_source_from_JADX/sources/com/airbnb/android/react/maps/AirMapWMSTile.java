...
public class AirMapWMSTile extends AirMapFeature {
    ...
    private TileOverlayOptions createTileOverlayOptions() {
        ...
        int i = this.tileSize;
        AIRMapGSUrlTileProvider aIRMapGSUrlTileProvider = new AIRMapGSUrlTileProvider(i, i, this.urlTemplate);
        this.tileProvider = aIRMapGSUrlTileProvider;
        tileOverlayOptions2.tileProvider(aIRMapGSUrlTileProvider);
