...
final class DistinguishedNameParser {
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f1309dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f1309dn);
            } else {
                i2 = c - '7';
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f1309dn.toCharArray();
