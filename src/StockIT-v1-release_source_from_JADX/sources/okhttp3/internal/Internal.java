...
public abstract class Internal {
    ...
    public abstract int code(C3401Response.Builder builder);

    public abstract boolean equalsNonHost(Address address, Address address2);

    @Nullable
    public abstract Exchange exchange(C3401Response response);

    public abstract void initExchange(C3401Response.Builder builder, Exchange exchange);
