...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public C3401Response.Builder readResponseHeaders(boolean z) throws IOException {
        ...
        if (i == 1 || i == 3) {
            try {
                ...
                C3401Response.Builder headers = new C3401Response.Builder().protocol(parse.protocol).code(parse.code).message(parse.message).headers(readHeaders());
                if (z && parse.code == 100) {
                    return null;
                }
                if (parse.code == 100) {
                ...
                RealConnection realConnection2 = this.realConnection;
                String redact = realConnection2 != null ? realConnection2.route().address().url().redact() : EnvironmentCompat.MEDIA_UNKNOWN;
    ...
    public void skipConnectBody(C3401Response response) throws IOException {
        long contentLength = HttpHeaders.contentLength(response);
        if (contentLength != -1) {
