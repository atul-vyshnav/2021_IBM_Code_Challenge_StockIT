...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    public void connect(p030rx.functions.Action1<? super p030rx.Subscription> r6) {
        /*
            r5 = this;
        ...
        L_0x000e:
            ...
            rx.subjects.Subject r1 = (p030rx.subjects.Subject) r1     // Catch:{ all -> 0x0071 }
            rx.Subscriber r2 = p030rx.observers.Subscribers.from(r1)     // Catch:{ all -> 0x0071 }
            ...
            rx.Subscription r3 = p030rx.subscriptions.Subscriptions.create(r3)     // Catch:{ all -> 0x0071 }
            r2.set(r3)     // Catch:{ all -> 0x0071 }
            java.lang.Object r2 = r2.get()     // Catch:{ all -> 0x0071 }
            rx.Subscription r2 = (p030rx.Subscription) r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x003b:
            ...
            rx.Subscriber r3 = (p030rx.Subscriber) r3     // Catch:{ all -> 0x0071 }
        ...
        L_0x0071:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p030rx.internal.operators.OperatorMulticast.connect(rx.functions.Action1):void");
    }
}
