...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C0064R.styleable.ActionMode_background));
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) linearLayout.findViewById(C0064R.C0067id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0064R.C0067id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0064R.C0067id.action_mode_close_button).setOnClickListener(new View.OnClickListener() {
