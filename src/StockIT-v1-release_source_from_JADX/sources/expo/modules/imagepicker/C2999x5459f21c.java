...
/* renamed from: expo.modules.imagepicker.ModuleRegistryPropertyDelegateKt$moduleRegistry$$inlined$getFromModuleRegistry$1 */
/* compiled from: ModuleRegistryPropertyDelegate.kt */
public final class C2999x5459f21c extends Lambda implements Function0<T> {
    final /* synthetic */ ModuleRegistryPropertyDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2999x5459f21c(ModuleRegistryPropertyDelegate moduleRegistryPropertyDelegate) {
        super(0);
